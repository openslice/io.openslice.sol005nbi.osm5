...
public class Example {
    ...
    public static void main(String[] args) throws IOException {
        ...
        OSM5VNFDExtractor vnfCirrosExtract = new OSM5VNFDExtractor(cirrosVnfFile);
        Vnfd cirrosVnfDescriptor = vnfCirrosExtract.extractVnfdDescriptor();
        OSM5VNFRequirements cirrosVnfRequirements = new OSM5VNFRequirements(cirrosVnfDescriptor);
