...
public class OSM5Client {
	...
	public OSM5Client(String apiEndpoint, String username, String password, String project_id) throws HttpStatusCodeException 
	{
	...
	private void OSM5ClientInit() throws HttpStatusCodeException
	{
...
//		}
        ...
        OSM5Client.setManoAuthorizationTokenTimeout(obj.getDouble("expires"));
        OSM5Client.setManoAuthorizationTokenID(obj.getString("id"));
        try {
			httpClient.close();
		} catch (IOException e) {
			// TODO Auto-generated catch block
	...
	private static String getManoAuthorizationTokenID() {
		...
		return OSM5Client.manoAuthorizationTokenID;
	}

	private static void setManoAuthorizationTokenID(String tokenID) {
		// TODO Auto-generated method stub
		OSM5Client.manoAuthorizationTokenID=tokenID;		
	}
