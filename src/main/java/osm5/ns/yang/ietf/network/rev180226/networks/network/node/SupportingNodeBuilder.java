...
/**
 * Class that builds {@link SupportingNodeBuilder} instances.
 * 
...
public class SupportingNodeBuilder implements Builder<SupportingNode> {
    ...
    public SupportingNodeBuilder(SupportingNode base) {
        ...
        if (base instanceof SupportingNodeImpl) {
            ...
            Map<Class<? extends Augmentation<SupportingNode>>, Augmentation<SupportingNode>> aug =((AugmentationHolder<SupportingNode>) base).augmentations();
            if (!aug.isEmpty()) {
    ...
    private static final class SupportingNodeImpl implements SupportingNode {
        ...
        public boolean equals(Object obj) {
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<Class<? extends Augmentation<SupportingNode>>, Augmentation<SupportingNode>> e : augmentation.entrySet()) {
