...
public class VldBuilder implements Builder<Vld> {
    ...
    public VldBuilder(osm5.ns.riftware._1._0.nsd.base.rev170228.NsdVldCommon arg) {
    ...
    public VldBuilder(osm5.ns.riftware._1._0.nsd.base.rev170228.VldCommon arg) {
        this._id = arg.getId();
        this._name = arg.getName();
        this._shortName = arg.getShortName();
        this._vendor = arg.getVendor();
    ...
    public VldBuilder(osm5.ns.yang.nfvo.mano.types.rev170208.ProviderNetwork arg) {
        this._providerNetwork = arg.getProviderNetwork();
    }
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof osm5.ns.riftware._1._0.nsd.base.rev170228.NsdVldCommon) {
            this._initParams = ((osm5.ns.riftware._1._0.nsd.base.rev170228.NsdVldCommon)arg).getInitParams();
            isValidArg = true;
        }
        CodeHelpers.validValue(isValidArg, arg, "[org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.nsd.base.rev170228.VldCommon, org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.ProviderNetwork, org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.nsd.base.rev170228.NsdVldCommon]");
    }
