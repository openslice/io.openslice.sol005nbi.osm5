...
import osm5.ns.yang.nfvo.nsd.rev170228.nsd.placement.groups.PlacementGroups;
import osm5.ns.yang.nfvo.nsd.rev170228.nsd.service.primitive.ServicePrimitive;
import osm5.ns.yang.nfvo.nsd.rev170228.nsd.vld.Vld;
import osm5.ns.yang.nfvo.nsd.rev170228.nsd.vnf.dependency.VnfDependency;
...
public class NsdBuilder implements Builder<Nsd> {
    ...
    public NsdBuilder(osm5.ns.yang.nfvo.nsd.rev170228.NsdMonitoringParam arg) {
        this._monitoringParam = arg.getMonitoringParam();
    }
    public NsdBuilder(osm5.ns.yang.nfvo.nsd.rev170228.NsdServicePrimitive arg) {
        this._servicePrimitive = arg.getServicePrimitive();
    }
    public NsdBuilder(osm5.ns.yang.nfvo.nsd.rev170228.NsdVld arg) {
        this._vld = arg.getVld();
    }
    public NsdBuilder(osm5.ns.yang.nfvo.nsd.rev170228.NsdConstituentVnfd arg) {
        this._constituentVnfd = arg.getConstituentVnfd();
    }
    public NsdBuilder(osm5.ns.yang.nfvo.nsd.rev170228.NsdPlacementGroups arg) {
    ...
    public NsdBuilder(osm5.ns.yang.nfvo.nsd.rev170228.NsdVnfDependency arg) {
     ...
     * <li>org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nsd.rev170228.NsdVld</li>
     * <li>org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nsd.rev170228.NsdPlacementGroups</li>
     * <li>org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nsd.rev170228.NsdServicePrimitive</li>
     * <li>org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nsd.rev170228.NsdMonitoringParam</li>
     * <li>org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nsd.rev170228.NsdConstituentVnfd</li>
     * <li>org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nsd.rev170228.NsdVnfDependency</li>
     * </ul>
     *
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof osm5.ns.yang.nfvo.nsd.rev170228.NsdVld) {
            this._vld = ((osm5.ns.yang.nfvo.nsd.rev170228.NsdVld)arg).getVld();
            isValidArg = true;
        }
        if (arg instanceof osm5.ns.yang.nfvo.nsd.rev170228.NsdPlacementGroups) {
            this._placementGroups = ((osm5.ns.yang.nfvo.nsd.rev170228.NsdPlacementGroups)arg).getPlacementGroups();
            isValidArg = true;
        }
        if (arg instanceof osm5.ns.yang.nfvo.nsd.rev170228.NsdServicePrimitive) {
            this._servicePrimitive = ((osm5.ns.yang.nfvo.nsd.rev170228.NsdServicePrimitive)arg).getServicePrimitive();
            isValidArg = true;
        }
        if (arg instanceof osm5.ns.yang.nfvo.nsd.rev170228.NsdMonitoringParam) {
            this._monitoringParam = ((osm5.ns.yang.nfvo.nsd.rev170228.NsdMonitoringParam)arg).getMonitoringParam();
            isValidArg = true;
        }
        if (arg instanceof osm5.ns.yang.nfvo.nsd.rev170228.NsdConstituentVnfd) {
            this._constituentVnfd = ((osm5.ns.yang.nfvo.nsd.rev170228.NsdConstituentVnfd)arg).getConstituentVnfd();
            isValidArg = true;
        }
        if (arg instanceof osm5.ns.yang.nfvo.nsd.rev170228.NsdVnfDependency) {
            this._vnfDependency = ((osm5.ns.yang.nfvo.nsd.rev170228.NsdVnfDependency)arg).getVnfDependency();
            isValidArg = true;
        }
        CodeHelpers.validValue(isValidArg, arg, "[org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.nsd.base.rev170228.NsdDescriptorCommon, org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.InputParameterXpath, org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.IpProfileList, org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nsd.rev170228.NsdVld, org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nsd.rev170228.NsdPlacementGroups, org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nsd.rev170228.NsdServicePrimitive, org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nsd.rev170228.NsdMonitoringParam, org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nsd.rev170228.NsdConstituentVnfd, org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nsd.rev170228.NsdVnfDependency]");
    }
