...
public class NetworkSliceTemplateBuilder implements Builder<NetworkSliceTemplate> {
    ...
    public NetworkSliceTemplateBuilder(osm5.ns.yang.nfvo.nst.rev180820.NetworkSlice arg) {
        this._id = arg.getId();
     ...
     * <ul>
     * <li>org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nst.rev180820.NetworkSlice</li>
     * </ul>
     *
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof osm5.ns.yang.nfvo.nst.rev180820.NetworkSlice) {
            this._id = ((osm5.ns.yang.nfvo.nst.rev180820.NetworkSlice)arg).getId();
            this._name = ((osm5.ns.yang.nfvo.nst.rev180820.NetworkSlice)arg).getName();
            this._sNSSAIIdentifier = ((osm5.ns.yang.nfvo.nst.rev180820.NetworkSlice)arg).getSNSSAIIdentifier();
            this._qualityOfService = ((osm5.ns.yang.nfvo.nst.rev180820.NetworkSlice)arg).getQualityOfService();
            this._netsliceSubnet = ((osm5.ns.yang.nfvo.nst.rev180820.NetworkSlice)arg).getNetsliceSubnet();
            this._netsliceConnectionPoint = ((osm5.ns.yang.nfvo.nst.rev180820.NetworkSlice)arg).getNetsliceConnectionPoint();
            this._netsliceVld = ((osm5.ns.yang.nfvo.nst.rev180820.NetworkSlice)arg).getNetsliceVld();
            this._netslicefgd = ((osm5.ns.yang.nfvo.nst.rev180820.NetworkSlice)arg).getNetslicefgd();
            isValidArg = true;
        }
        CodeHelpers.validValue(isValidArg, arg, "[org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nst.rev180820.NetworkSlice]");
    }
