...
public class NsiBuilder implements Builder<Nsi> {
    ...
    public NsiBuilder(osm5.ns.yang.nfvo.nsi.rev180928.Nsi$G arg) {
        this._id = arg.getId();
     ...
     * <ul>
     * <li>org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nsi.rev180928.Nsi$G</li>
     * </ul>
     *
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof osm5.ns.yang.nfvo.nsi.rev180928.Nsi$G) {
            this._id = ((osm5.ns.yang.nfvo.nsi.rev180928.Nsi$G)arg).getId();
            this._name = ((osm5.ns.yang.nfvo.nsi.rev180928.Nsi$G)arg).getName();
            this._shortName = ((osm5.ns.yang.nfvo.nsi.rev180928.Nsi$G)arg).getShortName();
            this._description = ((osm5.ns.yang.nfvo.nsi.rev180928.Nsi$G)arg).getDescription();
            this._nstRef = ((osm5.ns.yang.nfvo.nsi.rev180928.Nsi$G)arg).getNstRef();
            this._instantiationParameters = ((osm5.ns.yang.nfvo.nsi.rev180928.Nsi$G)arg).getInstantiationParameters();
            this._networkSliceTemplate = ((osm5.ns.yang.nfvo.nsi.rev180928.Nsi$G)arg).getNetworkSliceTemplate();
            this._nsrRefList = ((osm5.ns.yang.nfvo.nsi.rev180928.Nsi$G)arg).getNsrRefList();
            this._vlrList = ((osm5.ns.yang.nfvo.nsi.rev180928.Nsi$G)arg).getVlrList();
            isValidArg = true;
        }
        CodeHelpers.validValue(isValidArg, arg, "[org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nsi.rev180928.Nsi$G]");
    }
