...
public class InstantiationParametersBuilder implements Builder<InstantiationParameters> {
    ...
    public InstantiationParametersBuilder(osm5.ns.yang.nfvo.netslice.instantiation.parameters.rev181128.NetsliceParams arg) {
     ...
     * <ul>
     * <li>org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.netslice.instantiation.parameters.rev181128.NetsliceParams</li>
     * </ul>
     *
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof osm5.ns.yang.nfvo.netslice.instantiation.parameters.rev181128.NetsliceParams) {
            this._vimAccountId = ((osm5.ns.yang.nfvo.netslice.instantiation.parameters.rev181128.NetsliceParams)arg).getVimAccountId();
            this._sshKeys = ((osm5.ns.yang.nfvo.netslice.instantiation.parameters.rev181128.NetsliceParams)arg).getSshKeys();
            this._netsliceSubnet = ((osm5.ns.yang.nfvo.netslice.instantiation.parameters.rev181128.NetsliceParams)arg).getNetsliceSubnet();
            this._netsliceVld = ((osm5.ns.yang.nfvo.netslice.instantiation.parameters.rev181128.NetsliceParams)arg).getNetsliceVld();
            isValidArg = true;
        }
        CodeHelpers.validValue(isValidArg, arg, "[org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.netslice.instantiation.parameters.rev181128.NetsliceParams]");
    }
