...
public final class $YangModuleInfoImpl extends ResourceYangModuleInfo {
    private static final QName NAME = QName.create("urn:ietf:params:xml:ns:yang:nfvo:netslice-instantiation-parameters", "2018-11-28", "netslice-instantiation-parameters").intern();
