...
public class NetsliceVldBuilder implements Builder<NetsliceVld> {
    ...
    public NetsliceVldBuilder(osm5.ns.yang.nfvo.netslice.instantiation.parameters.rev181128.NetsliceVldParams arg) {
    ...
    public NetsliceVldBuilder(osm5.ns.yang.nfvo.instantiation.parameters.rev180914.VldCommonParams arg) {
        this._name = arg.getName();
        this._vimNetworkName = arg.getVimNetworkName();
        this._ipProfile = arg.getIpProfile();
    }
     ...
     * <ul>
     * <li>org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.netslice.instantiation.parameters.rev181128.NetsliceVldParams</li>
     * <li>org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.instantiation.parameters.rev180914.VldCommonParams</li>
     * </ul>
     *
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof osm5.ns.yang.nfvo.netslice.instantiation.parameters.rev181128.NetsliceVldParams) {
            this._nssConnectionPointRef = ((osm5.ns.yang.nfvo.netslice.instantiation.parameters.rev181128.NetsliceVldParams)arg).getNssConnectionPointRef();
            isValidArg = true;
        }
        if (arg instanceof osm5.ns.yang.nfvo.instantiation.parameters.rev180914.VldCommonParams) {
            this._name = ((osm5.ns.yang.nfvo.instantiation.parameters.rev180914.VldCommonParams)arg).getName();
            this._vimNetworkName = ((osm5.ns.yang.nfvo.instantiation.parameters.rev180914.VldCommonParams)arg).getVimNetworkName();
            this._ipProfile = ((osm5.ns.yang.nfvo.instantiation.parameters.rev180914.VldCommonParams)arg).getIpProfile();
            isValidArg = true;
        }
        CodeHelpers.validValue(isValidArg, arg, "[org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.netslice.instantiation.parameters.rev181128.NetsliceVldParams, org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.instantiation.parameters.rev180914.VldCommonParams]");
    }
