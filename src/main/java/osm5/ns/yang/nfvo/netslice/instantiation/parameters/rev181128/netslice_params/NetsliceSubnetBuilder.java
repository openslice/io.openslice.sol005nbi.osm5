...
public class NetsliceSubnetBuilder implements Builder<NetsliceSubnet> {
    ...
    public NetsliceSubnetBuilder(osm5.ns.yang.nfvo.netslice.instantiation.parameters.rev181128.NetsliceSubnetParams arg) {
        this._id = arg.getId();
    ...
    public NetsliceSubnetBuilder(osm5.ns.yang.nfvo.instantiation.parameters.rev180914.NsParams arg) {
        this._vimAccountId = arg.getVimAccountId();
        this._sshKeys = arg.getSshKeys();
        this._vnf = arg.getVnf();
        this._vld = arg.getVld();
     ...
     * <ul>
     * <li>org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.netslice.instantiation.parameters.rev181128.NetsliceSubnetParams</li>
     * <li>org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.instantiation.parameters.rev180914.NsParams</li>
     * </ul>
     *
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof osm5.ns.yang.nfvo.netslice.instantiation.parameters.rev181128.NetsliceSubnetParams) {
            this._id = ((osm5.ns.yang.nfvo.netslice.instantiation.parameters.rev181128.NetsliceSubnetParams)arg).getId();
            isValidArg = true;
        }
        if (arg instanceof osm5.ns.yang.nfvo.instantiation.parameters.rev180914.NsParams) {
            this._vimAccountId = ((osm5.ns.yang.nfvo.instantiation.parameters.rev180914.NsParams)arg).getVimAccountId();
            this._sshKeys = ((osm5.ns.yang.nfvo.instantiation.parameters.rev180914.NsParams)arg).getSshKeys();
            this._vnf = ((osm5.ns.yang.nfvo.instantiation.parameters.rev180914.NsParams)arg).getVnf();
            this._vld = ((osm5.ns.yang.nfvo.instantiation.parameters.rev180914.NsParams)arg).getVld();
            isValidArg = true;
        }
        CodeHelpers.validValue(isValidArg, arg, "[org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.netslice.instantiation.parameters.rev181128.NetsliceSubnetParams, org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.instantiation.parameters.rev180914.NsParams]");
    }
