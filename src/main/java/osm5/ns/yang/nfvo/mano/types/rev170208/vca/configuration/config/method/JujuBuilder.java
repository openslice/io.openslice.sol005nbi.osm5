...
public class JujuBuilder implements Builder<Juju> {
    ...
    private osm5.ns.yang.nfvo.mano.types.rev170208.vca.configuration.config.method.juju.Juju _juju;
    ...
    public osm5.ns.yang.nfvo.mano.types.rev170208.vca.configuration.config.method.juju.Juju getJuju() {
        return _juju;
    }
    ...
    public JujuBuilder setJuju(final osm5.ns.yang.nfvo.mano.types.rev170208.vca.configuration.config.method.juju.Juju value) {
        this._juju = value;
        return this;
    }
    ...
    private static final class JujuImpl implements Juju {
        ...
        private final osm5.ns.yang.nfvo.mano.types.rev170208.vca.configuration.config.method.juju.Juju _juju;
