...
/**
 * Class that builds {@link HostEpaBuilder} instances.
 * 
 * @see HostEpaBuilder
 *
 */
public class HostEpaBuilder implements Builder<HostEpa> {
    ...
    private static final class HostEpaImpl implements HostEpa {
        ...
        private Map<Class<? extends Augmentation<HostEpa>>, Augmentation<HostEpa>> augmentation = Collections.emptyMap();
        ...
        public boolean equals(Object obj) {
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<Class<? extends Augmentation<HostEpa>>, Augmentation<HostEpa>> e : augmentation.entrySet()) {
