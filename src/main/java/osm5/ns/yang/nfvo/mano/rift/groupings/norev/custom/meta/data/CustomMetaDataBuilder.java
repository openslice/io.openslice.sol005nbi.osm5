package osm5.ns.yang.nfvo.mano.rift.groupings.norev.custom.meta.data;
import com.google.common.base.MoreObjects;
import com.google.common.collect.ImmutableMap;

import osm5.ns.yang.nfvo.mano.types.rev170208.MetaDataType;
...
/**
 * Class that builds {@link CustomMetaDataBuilder} instances.
 * 
...
public class CustomMetaDataBuilder implements Builder<CustomMetaData> {
    ...
    public CustomMetaDataBuilder(CustomMetaData base) {
        ...
        if (base instanceof CustomMetaDataImpl) {
            ...
            Map<Class<? extends Augmentation<CustomMetaData>>, Augmentation<CustomMetaData>> aug =((AugmentationHolder<CustomMetaData>) base).augmentations();
            if (!aug.isEmpty()) {
    ...
    private static final class CustomMetaDataImpl implements CustomMetaData {
        ...
        CustomMetaDataImpl(CustomMetaDataBuilder base) {
            if (base.key() != null) {
                this.key = base.key();
            } else {
                this.key = new CustomMetaDataKey(base.getName());
            }
