...
import osm5.ns.yang.nfvo.mano.types.rev170208.host.aggregate.HostAggregate;
...
public class OpenstackBuilder implements Builder<Openstack> {
    ...
    public OpenstackBuilder(osm5.ns.yang.nfvo.mano.types.rev170208.HostAggregate arg) {
     ...
     * <ul>
     * <li>org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.HostAggregate</li>
     * </ul>
     *
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof osm5.ns.yang.nfvo.mano.types.rev170208.HostAggregate) {
            this._hostAggregate = ((osm5.ns.yang.nfvo.mano.types.rev170208.HostAggregate)arg).getHostAggregate();
            isValidArg = true;
        }
        CodeHelpers.validValue(isValidArg, arg, "[org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.HostAggregate]");
    }
