...
public class ScriptBuilder implements Builder<Script> {
    ...
    private osm5.ns.yang.nfvo.mano.types.rev170208.vca.configuration.config.method.script.Script _script;
    ...
    public osm5.ns.yang.nfvo.mano.types.rev170208.vca.configuration.config.method.script.Script getScript() {
        return _script;
    }
    ...
    public ScriptBuilder setScript(final osm5.ns.yang.nfvo.mano.types.rev170208.vca.configuration.config.method.script.Script value) {
        this._script = value;
        return this;
    }
    ...
    private static final class ScriptImpl implements Script {
        ...
        private final osm5.ns.yang.nfvo.mano.types.rev170208.vca.configuration.config.method.script.Script _script;
