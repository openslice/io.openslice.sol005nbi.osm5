...
/**
 * Class that builds {@link PairedThreadsBuilder} instances.
 * 
...
public class PairedThreadsBuilder implements Builder<PairedThreads> {
    ...
    private osm5.ns.yang.nfvo.mano.types.rev170208.guest.epa.guest.epa.numa.policy.numa.aware.numa.node.policy.node.om.numa.type.paired.threads.PairedThreads _pairedThreads;
    ...
    public osm5.ns.yang.nfvo.mano.types.rev170208.guest.epa.guest.epa.numa.policy.numa.aware.numa.node.policy.node.om.numa.type.paired.threads.PairedThreads getPairedThreads() {
    ...
    public PairedThreadsBuilder setPairedThreads(final osm5.ns.yang.nfvo.mano.types.rev170208.guest.epa.guest.epa.numa.policy.numa.aware.numa.node.policy.node.om.numa.type.paired.threads.PairedThreads value) {
    ...
    private static final class PairedThreadsImpl implements PairedThreads {
        ...
        private final osm5.ns.yang.nfvo.mano.types.rev170208.guest.epa.guest.epa.numa.policy.numa.aware.numa.node.policy.node.om.numa.type.paired.threads.PairedThreads _pairedThreads;
