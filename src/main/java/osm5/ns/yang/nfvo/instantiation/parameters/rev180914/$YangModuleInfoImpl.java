...
public final class $YangModuleInfoImpl extends ResourceYangModuleInfo {
    private static final QName NAME = QName.create("urn:ietf:params:xml:ns:yang:nfvo:instantiation-parameters", "2018-09-14", "instantiation-parameters").intern();
    ...
    private $YangModuleInfoImpl() {
        ...
        set.add(osm5.ns.yang.nfvo.vnfd.rev170228.$YangModuleInfoImpl.getInstance());
