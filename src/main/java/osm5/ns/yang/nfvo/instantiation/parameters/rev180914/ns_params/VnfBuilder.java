...
public class VnfBuilder implements Builder<Vnf> {
    ...
    public VnfBuilder(osm5.ns.yang.nfvo.instantiation.parameters.rev180914.VnfParams arg) {
     ...
     * <ul>
     * <li>org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.instantiation.parameters.rev180914.VnfParams</li>
     * </ul>
     *
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof osm5.ns.yang.nfvo.instantiation.parameters.rev180914.VnfParams) {
            this._memberVnfIndex = ((osm5.ns.yang.nfvo.instantiation.parameters.rev180914.VnfParams)arg).getMemberVnfIndex();
            this._vimAccountId = ((osm5.ns.yang.nfvo.instantiation.parameters.rev180914.VnfParams)arg).getVimAccountId();
            this._vdu = ((osm5.ns.yang.nfvo.instantiation.parameters.rev180914.VnfParams)arg).getVdu();
            this._internalVld = ((osm5.ns.yang.nfvo.instantiation.parameters.rev180914.VnfParams)arg).getInternalVld();
            isValidArg = true;
        }
        CodeHelpers.validValue(isValidArg, arg, "[org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.instantiation.parameters.rev180914.VnfParams]");
    }
