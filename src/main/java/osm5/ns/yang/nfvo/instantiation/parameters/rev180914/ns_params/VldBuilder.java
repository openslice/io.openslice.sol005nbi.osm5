...
public class VldBuilder implements Builder<Vld> {
    ...
    public VldBuilder(osm5.ns.yang.nfvo.instantiation.parameters.rev180914.VldParams arg) {
    ...
    public VldBuilder(osm5.ns.yang.nfvo.instantiation.parameters.rev180914.VldCommonParams arg) {
        this._name = arg.getName();
        this._vimNetworkName = arg.getVimNetworkName();
        this._ipProfile = arg.getIpProfile();
    }
     ...
     * <ul>
     * <li>org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.instantiation.parameters.rev180914.VldParams</li>
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof osm5.ns.yang.nfvo.instantiation.parameters.rev180914.VldParams) {
            this._vnfdConnectionPointRef = ((osm5.ns.yang.nfvo.instantiation.parameters.rev180914.VldParams)arg).getVnfdConnectionPointRef();
            isValidArg = true;
        }
        ...
        CodeHelpers.validValue(isValidArg, arg, "[org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.instantiation.parameters.rev180914.VldParams, org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.instantiation.parameters.rev180914.VldCommonParams]");
    }
