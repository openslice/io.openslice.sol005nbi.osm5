...
public class IpProfileBuilder implements Builder<IpProfile> {
    ...
    public IpProfileBuilder(osm5.ns.yang.nfvo.instantiation.parameters.rev180914.IpProfileUpdateSchema arg) {
     ...
     * <ul>
     * <li>org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.instantiation.parameters.rev180914.IpProfileUpdateSchema</li>
     * </ul>
     *
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof osm5.ns.yang.nfvo.instantiation.parameters.rev180914.IpProfileUpdateSchema) {
            this._ipVersion = ((osm5.ns.yang.nfvo.instantiation.parameters.rev180914.IpProfileUpdateSchema)arg).getIpVersion();
            this._subnetAddress = ((osm5.ns.yang.nfvo.instantiation.parameters.rev180914.IpProfileUpdateSchema)arg).getSubnetAddress();
            this._gatewayAddress = ((osm5.ns.yang.nfvo.instantiation.parameters.rev180914.IpProfileUpdateSchema)arg).getGatewayAddress();
            this._dnsServer = ((osm5.ns.yang.nfvo.instantiation.parameters.rev180914.IpProfileUpdateSchema)arg).getDnsServer();
            this._dhcpParams = ((osm5.ns.yang.nfvo.instantiation.parameters.rev180914.IpProfileUpdateSchema)arg).getDhcpParams();
            isValidArg = true;
        }
        CodeHelpers.validValue(isValidArg, arg, "[org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.instantiation.parameters.rev180914.IpProfileUpdateSchema]");
    }
