...
import osm5.ns.yang.nfvo.instantiation.parameters.rev180914.vdu_params.Interface;
import osm5.ns.yang.nfvo.instantiation.parameters.rev180914.vdu_params.Volume;
...
public class VduBuilder implements Builder<Vdu> {
    ...
    public VduBuilder(osm5.ns.yang.nfvo.instantiation.parameters.rev180914.VduParams arg) {
        this._id = arg.getId();
     ...
     * <ul>
     * <li>org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.instantiation.parameters.rev180914.VduParams</li>
     * </ul>
     *
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof osm5.ns.yang.nfvo.instantiation.parameters.rev180914.VduParams) {
            this._id = ((osm5.ns.yang.nfvo.instantiation.parameters.rev180914.VduParams)arg).getId();
            this._volume = ((osm5.ns.yang.nfvo.instantiation.parameters.rev180914.VduParams)arg).getVolume();
            this._interface = ((osm5.ns.yang.nfvo.instantiation.parameters.rev180914.VduParams)arg).getInterface();
            isValidArg = true;
        }
        CodeHelpers.validValue(isValidArg, arg, "[org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.instantiation.parameters.rev180914.VduParams]");
    }
