...
public class InternalVldBuilder implements Builder<InternalVld> {
    ...
    public InternalVldBuilder(osm5.ns.yang.nfvo.instantiation.parameters.rev180914.InternalVldParams arg) {
     ...
     * <ul>
     * <li>org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.instantiation.parameters.rev180914.InternalVldParams</li>
     * </ul>
     *
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof osm5.ns.yang.nfvo.instantiation.parameters.rev180914.InternalVldParams) {
            this._name = ((osm5.ns.yang.nfvo.instantiation.parameters.rev180914.InternalVldParams)arg).getName();
            this._vimNetworkName = ((osm5.ns.yang.nfvo.instantiation.parameters.rev180914.InternalVldParams)arg).getVimNetworkName();
            this._ipProfile = ((osm5.ns.yang.nfvo.instantiation.parameters.rev180914.InternalVldParams)arg).getIpProfile();
            this._internalConnectionPoint = ((osm5.ns.yang.nfvo.instantiation.parameters.rev180914.InternalVldParams)arg).getInternalConnectionPoint();
            isValidArg = true;
        }
        CodeHelpers.validValue(isValidArg, arg, "[org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.instantiation.parameters.rev180914.InternalVldParams]");
    }
