package osm5.ns.yang.nfvo.vlr.rev170208.project.vlr.catalog;
...
/**
 * Class that builds {@link VlrBuilder} instances.
 * 
 * @see VlrBuilder
 *
 */
public class VlrBuilder implements Builder<Vlr> {
    ...
    public VlrBuilder(osm5.ns.yang.nfvo.mano.types.rev170208.IpProfileInfo arg) {
        this._ipProfileParams = arg.getIpProfileParams();
    }
    public VlrBuilder(osm5.ns.yang.nfvo.mano.types.rev170208.ProviderNetwork arg) {
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof osm5.ns.yang.nfvo.mano.types.rev170208.IpProfileInfo) {
            this._ipProfileParams = ((osm5.ns.yang.nfvo.mano.types.rev170208.IpProfileInfo)arg).getIpProfileParams();
            isValidArg = true;
        }
        ...
        CodeHelpers.validValue(isValidArg, arg, "[org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.IpProfileInfo, org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.ProviderNetwork]");
    }
