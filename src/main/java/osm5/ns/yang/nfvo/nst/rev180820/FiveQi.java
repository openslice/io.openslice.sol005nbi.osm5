    ...
    DataObject
{
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nst.rev180820.ResourceType</code> <code>resourceType</code>, or <code>null</code> if not present
     */
    @Nullable
