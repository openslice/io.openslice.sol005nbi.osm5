...
public class NetslicefgdBuilder implements Builder<Netslicefgd> {
    ...
    public NetslicefgdBuilder(osm5.ns.yang.nfvo.nst.rev180820.Netslicefgd arg) {
    ...
    public NetslicefgdBuilder(osm5.ns.riftware._1._0.nsd.base.rev170228.FgdCommon arg) {
        this._id = arg.getId();
        this._name = arg.getName();
        this._shortName = arg.getShortName();
        this._vendor = arg.getVendor();
     ...
     * <ul>
     * <li>org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nst.rev180820.Netslicefgd</li>
     * <li>org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.nsd.base.rev170228.FgdCommon</li>
     * </ul>
     *
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof osm5.ns.yang.nfvo.nst.rev180820.Netslicefgd) {
            this._rsp = ((osm5.ns.yang.nfvo.nst.rev180820.Netslicefgd)arg).getRsp();
            this._classifier = ((osm5.ns.yang.nfvo.nst.rev180820.Netslicefgd)arg).getClassifier();
            isValidArg = true;
        }
        if (arg instanceof osm5.ns.riftware._1._0.nsd.base.rev170228.FgdCommon) {
            this._id = ((osm5.ns.riftware._1._0.nsd.base.rev170228.FgdCommon)arg).getId();
            this._name = ((osm5.ns.riftware._1._0.nsd.base.rev170228.FgdCommon)arg).getName();
            this._shortName = ((osm5.ns.riftware._1._0.nsd.base.rev170228.FgdCommon)arg).getShortName();
            this._vendor = ((osm5.ns.riftware._1._0.nsd.base.rev170228.FgdCommon)arg).getVendor();
            this._description = ((osm5.ns.riftware._1._0.nsd.base.rev170228.FgdCommon)arg).getDescription();
            this._version = ((osm5.ns.riftware._1._0.nsd.base.rev170228.FgdCommon)arg).getVersion();
            isValidArg = true;
        }
        CodeHelpers.validValue(isValidArg, arg, "[org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nst.rev180820.Netslicefgd, org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.nsd.base.rev170228.FgdCommon]");
    }
