...
import osm5.ns.yang.nfvo.mano.types.rev170208.provider.network.ProviderNetwork;
...
public class NetsliceVldBuilder implements Builder<NetsliceVld> {
    ...
    public NetsliceVldBuilder(osm5.ns.yang.nfvo.nst.rev180820.Nsvld arg) {
    ...
    public NetsliceVldBuilder(osm5.ns.riftware._1._0.nsd.base.rev170228.VldCommon arg) {
        this._id = arg.getId();
        this._name = arg.getName();
        this._shortName = arg.getShortName();
        this._vendor = arg.getVendor();
    ...
    public NetsliceVldBuilder(osm5.ns.yang.nfvo.mano.types.rev170208.ProviderNetwork arg) {
        this._providerNetwork = arg.getProviderNetwork();
    }
     ...
     * <ul>
     * <li>org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.nsd.base.rev170228.VldCommon</li>
     * <li>org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nst.rev180820.Nsvld</li>
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof osm5.ns.riftware._1._0.nsd.base.rev170228.VldCommon) {
            this._id = ((osm5.ns.riftware._1._0.nsd.base.rev170228.VldCommon)arg).getId();
            this._name = ((osm5.ns.riftware._1._0.nsd.base.rev170228.VldCommon)arg).getName();
            this._shortName = ((osm5.ns.riftware._1._0.nsd.base.rev170228.VldCommon)arg).getShortName();
            this._vendor = ((osm5.ns.riftware._1._0.nsd.base.rev170228.VldCommon)arg).getVendor();
            this._description = ((osm5.ns.riftware._1._0.nsd.base.rev170228.VldCommon)arg).getDescription();
            this._version = ((osm5.ns.riftware._1._0.nsd.base.rev170228.VldCommon)arg).getVersion();
            this._type = ((osm5.ns.riftware._1._0.nsd.base.rev170228.VldCommon)arg).getType();
            this._rootBandwidth = ((osm5.ns.riftware._1._0.nsd.base.rev170228.VldCommon)arg).getRootBandwidth();
            this._leafBandwidth = ((osm5.ns.riftware._1._0.nsd.base.rev170228.VldCommon)arg).getLeafBandwidth();
            this._mgmtNetwork = ((osm5.ns.riftware._1._0.nsd.base.rev170228.VldCommon)arg).isMgmtNetwork();
            isValidArg = true;
        }
        if (arg instanceof osm5.ns.yang.nfvo.nst.rev180820.Nsvld) {
            this._nssConnectionPointRef = ((osm5.ns.yang.nfvo.nst.rev180820.Nsvld)arg).getNssConnectionPointRef();
            isValidArg = true;
        }
        if (arg instanceof osm5.ns.yang.nfvo.mano.types.rev170208.ProviderNetwork) {
            this._providerNetwork = ((osm5.ns.yang.nfvo.mano.types.rev170208.ProviderNetwork)arg).getProviderNetwork();
            isValidArg = true;
        }
        CodeHelpers.validValue(isValidArg, arg, "[org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.nsd.base.rev170228.VldCommon, org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nst.rev180820.Nsvld, org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.ProviderNetwork]");
    }
