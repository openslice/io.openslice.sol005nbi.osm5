...
import osm5.ns.yang.nfvo.nst.rev180820.ResourceType;
...
public class QualityOfServiceBuilder implements Builder<QualityOfService> {
    ...
    public QualityOfServiceBuilder(osm5.ns.yang.nfvo.nst.rev180820.FiveQi arg) {
        this._id = arg.getId();
     ...
     * <ul>
     * <li>org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nst.rev180820.FiveQi</li>
     * </ul>
     *
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof osm5.ns.yang.nfvo.nst.rev180820.FiveQi) {
            this._id = ((osm5.ns.yang.nfvo.nst.rev180820.FiveQi)arg).getId();
            this._resourceType = ((osm5.ns.yang.nfvo.nst.rev180820.FiveQi)arg).getResourceType();
            this._priorityLevel = ((osm5.ns.yang.nfvo.nst.rev180820.FiveQi)arg).getPriorityLevel();
            this._packetDelayBudget = ((osm5.ns.yang.nfvo.nst.rev180820.FiveQi)arg).getPacketDelayBudget();
            this._packetErrorRate = ((osm5.ns.yang.nfvo.nst.rev180820.FiveQi)arg).getPacketErrorRate();
            this._defaultMaxDataBurst = ((osm5.ns.yang.nfvo.nst.rev180820.FiveQi)arg).getDefaultMaxDataBurst();
            isValidArg = true;
        }
        CodeHelpers.validValue(isValidArg, arg, "[org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nst.rev180820.FiveQi]");
    }
