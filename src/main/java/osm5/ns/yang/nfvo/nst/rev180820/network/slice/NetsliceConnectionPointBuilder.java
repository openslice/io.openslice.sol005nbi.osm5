...
public class NetsliceConnectionPointBuilder implements Builder<NetsliceConnectionPoint> {
    ...
    public NetsliceConnectionPointBuilder(osm5.ns.yang.nfvo.nst.rev180820.SliceConnectionPoints arg) {
        this._connection = arg.getConnection();
        this._name = arg.getName();
        this._floatingIpRequired = arg.isFloatingIpRequired();
    }
    public NetsliceConnectionPointBuilder(osm5.ns.riftware._1._0.nsd.base.rev170228.NsdConnectionPointCommon arg) {
        this._name = arg.getName();
        this._floatingIpRequired = arg.isFloatingIpRequired();
    }
     ...
     * <ul>
     * <li>org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.nsd.base.rev170228.NsdConnectionPointCommon</li>
     * <li>org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nst.rev180820.SliceConnectionPoints</li>
     * </ul>
     *
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof osm5.ns.riftware._1._0.nsd.base.rev170228.NsdConnectionPointCommon) {
            this._name = ((osm5.ns.riftware._1._0.nsd.base.rev170228.NsdConnectionPointCommon)arg).getName();
            this._floatingIpRequired = ((osm5.ns.riftware._1._0.nsd.base.rev170228.NsdConnectionPointCommon)arg).isFloatingIpRequired();
            isValidArg = true;
        }
        if (arg instanceof osm5.ns.yang.nfvo.nst.rev180820.SliceConnectionPoints) {
            this._connection = ((osm5.ns.yang.nfvo.nst.rev180820.SliceConnectionPoints)arg).getConnection();
            isValidArg = true;
        }
        CodeHelpers.validValue(isValidArg, arg, "[org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.nsd.base.rev170228.NsdConnectionPointCommon, org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nst.rev180820.SliceConnectionPoints]");
    }
