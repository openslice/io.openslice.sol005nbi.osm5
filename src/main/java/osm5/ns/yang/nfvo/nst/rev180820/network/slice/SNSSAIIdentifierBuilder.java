...
import osm5.ns.yang.nfvo.nst.rev180820.NetworkSliceType;
...
public class SNSSAIIdentifierBuilder implements Builder<SNSSAIIdentifier> {
    ...
    public SNSSAIIdentifierBuilder(osm5.ns.yang.nfvo.nst.rev180820.Snssai arg) {
     ...
     * <ul>
     * <li>org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nst.rev180820.Snssai</li>
     * </ul>
     *
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof osm5.ns.yang.nfvo.nst.rev180820.Snssai) {
            this._sliceServiceType = ((osm5.ns.yang.nfvo.nst.rev180820.Snssai)arg).getSliceServiceType();
            this._sliceDifferentiator = ((osm5.ns.yang.nfvo.nst.rev180820.Snssai)arg).getSliceDifferentiator();
            isValidArg = true;
        }
        CodeHelpers.validValue(isValidArg, arg, "[org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nst.rev180820.Snssai]");
    }
