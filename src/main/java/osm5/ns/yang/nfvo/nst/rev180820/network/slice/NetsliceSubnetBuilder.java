...
public class NetsliceSubnetBuilder implements Builder<NetsliceSubnet> {
    ...
    public NetsliceSubnetBuilder(osm5.ns.yang.nfvo.nst.rev180820.NetsliceSubnet arg) {
        this._id = arg.getId();
     ...
     * <ul>
     * <li>org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nst.rev180820.NetsliceSubnet</li>
     * </ul>
     *
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof osm5.ns.yang.nfvo.nst.rev180820.NetsliceSubnet) {
            this._id = ((osm5.ns.yang.nfvo.nst.rev180820.NetsliceSubnet)arg).getId();
            this._description = ((osm5.ns.yang.nfvo.nst.rev180820.NetsliceSubnet)arg).getDescription();
            this._isSharedNss = ((osm5.ns.yang.nfvo.nst.rev180820.NetsliceSubnet)arg).isIsSharedNss();
            this._nsdRef = ((osm5.ns.yang.nfvo.nst.rev180820.NetsliceSubnet)arg).getNsdRef();
            this._instantiationParameters = ((osm5.ns.yang.nfvo.nst.rev180820.NetsliceSubnet)arg).getInstantiationParameters();
            isValidArg = true;
        }
        CodeHelpers.validValue(isValidArg, arg, "[org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nst.rev180820.NetsliceSubnet]");
    }
