...
public class ClassifierBuilder implements Builder<Classifier> {
    ...
    public ClassifierBuilder(osm5.ns.yang.nfvo.nst.rev180820.Classifier arg) {
    ...
    public ClassifierBuilder(osm5.ns.riftware._1._0.nsd.base.rev170228.ClassifierCommon arg) {
        this._id = arg.getId();
        this._name = arg.getName();
        this._rspIdRef = arg.getRspIdRef();
        this._matchAttributes = arg.getMatchAttributes();
     ...
     * <ul>
     * <li>org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.nsd.base.rev170228.ClassifierCommon</li>
     * <li>org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nst.rev180820.Classifier</li>
     * </ul>
     *
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof osm5.ns.riftware._1._0.nsd.base.rev170228.ClassifierCommon) {
            this._id = ((osm5.ns.riftware._1._0.nsd.base.rev170228.ClassifierCommon)arg).getId();
            this._name = ((osm5.ns.riftware._1._0.nsd.base.rev170228.ClassifierCommon)arg).getName();
            this._rspIdRef = ((osm5.ns.riftware._1._0.nsd.base.rev170228.ClassifierCommon)arg).getRspIdRef();
            this._matchAttributes = ((osm5.ns.riftware._1._0.nsd.base.rev170228.ClassifierCommon)arg).getMatchAttributes();
            isValidArg = true;
        }
        if (arg instanceof osm5.ns.yang.nfvo.nst.rev180820.Classifier) {
            this._nsdRef = ((osm5.ns.yang.nfvo.nst.rev180820.Classifier)arg).getNsdRef();
            this._nsdConnectionPointRef = ((osm5.ns.yang.nfvo.nst.rev180820.Classifier)arg).getNsdConnectionPointRef();
            isValidArg = true;
        }
        CodeHelpers.validValue(isValidArg, arg, "[org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.nsd.base.rev170228.ClassifierCommon, org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nst.rev180820.Classifier]");
    }
