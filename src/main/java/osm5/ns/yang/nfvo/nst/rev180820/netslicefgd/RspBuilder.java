...
public class RspBuilder implements Builder<Rsp> {
    ...
    private List<NsdConnectionPointRef> _nsdConnectionPointRef;
    private RspKey key;
    ...
    public RspBuilder(osm5.ns.yang.nfvo.nst.rev180820.Rsp arg) {
        this._nsdConnectionPointRef = arg.getNsdConnectionPointRef();
        this._id = arg.getId();
        this._name = arg.getName();
    }
    public RspBuilder(osm5.ns.riftware._1._0.nsd.base.rev170228.RspCommon arg) {
        this._id = arg.getId();
        this._name = arg.getName();
    }
     ...
     * <ul>
     * <li>org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nst.rev180820.Rsp</li>
     * <li>org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.nsd.base.rev170228.RspCommon</li>
     * </ul>
     *
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof osm5.ns.yang.nfvo.nst.rev180820.Rsp) {
            this._nsdConnectionPointRef = ((osm5.ns.yang.nfvo.nst.rev180820.Rsp)arg).getNsdConnectionPointRef();
            isValidArg = true;
        }
        if (arg instanceof osm5.ns.riftware._1._0.nsd.base.rev170228.RspCommon) {
            this._id = ((osm5.ns.riftware._1._0.nsd.base.rev170228.RspCommon)arg).getId();
            this._name = ((osm5.ns.riftware._1._0.nsd.base.rev170228.RspCommon)arg).getName();
            isValidArg = true;
        }
        CodeHelpers.validValue(isValidArg, arg, "[org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nst.rev180820.Rsp, org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.nsd.base.rev170228.RspCommon]");
    }
    ...
    public List<NsdConnectionPointRef> getNsdConnectionPointRef() {
    ...
    private static final class RspImpl implements Rsp {
        ...
        private final List<NsdConnectionPointRef> _nsdConnectionPointRef;
