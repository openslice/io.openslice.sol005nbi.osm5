...
public class VduMetricBuilder implements Builder<VduMetric> {
    ...
    private osm5.ns.yang.nfvo.vnfr.rev170228.project.vnfr.catalog.vnfr.monitoring.param.monitoring.type.vdu.metric.VduMetric _vduMetric;
    ...
    public osm5.ns.yang.nfvo.vnfr.rev170228.project.vnfr.catalog.vnfr.monitoring.param.monitoring.type.vdu.metric.VduMetric getVduMetric() {
        return _vduMetric;
    }
    ...
    public VduMetricBuilder setVduMetric(final osm5.ns.yang.nfvo.vnfr.rev170228.project.vnfr.catalog.vnfr.monitoring.param.monitoring.type.vdu.metric.VduMetric value) {
    ...
    private static final class VduMetricImpl implements VduMetric {
        ...
        private final osm5.ns.yang.nfvo.vnfr.rev170228.project.vnfr.catalog.vnfr.monitoring.param.monitoring.type.vdu.metric.VduMetric _vduMetric;
