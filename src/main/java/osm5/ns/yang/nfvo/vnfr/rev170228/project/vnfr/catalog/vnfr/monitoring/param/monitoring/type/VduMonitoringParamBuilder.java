...
public class VduMonitoringParamBuilder implements Builder<VduMonitoringParam> {
    ...
    private osm5.ns.yang.nfvo.vnfr.rev170228.project.vnfr.catalog.vnfr.monitoring.param.monitoring.type.vdu.monitoring.param.VduMonitoringParam _vduMonitoringParam;
    ...
    public osm5.ns.yang.nfvo.vnfr.rev170228.project.vnfr.catalog.vnfr.monitoring.param.monitoring.type.vdu.monitoring.param.VduMonitoringParam getVduMonitoringParam() {
    ...
    public VduMonitoringParamBuilder setVduMonitoringParam(final osm5.ns.yang.nfvo.vnfr.rev170228.project.vnfr.catalog.vnfr.monitoring.param.monitoring.type.vdu.monitoring.param.VduMonitoringParam value) {
    ...
    private static final class VduMonitoringParamImpl implements VduMonitoringParam {
        ...
        private final osm5.ns.yang.nfvo.vnfr.rev170228.project.vnfr.catalog.vnfr.monitoring.param.monitoring.type.vdu.monitoring.param.VduMonitoringParam _vduMonitoringParam;
