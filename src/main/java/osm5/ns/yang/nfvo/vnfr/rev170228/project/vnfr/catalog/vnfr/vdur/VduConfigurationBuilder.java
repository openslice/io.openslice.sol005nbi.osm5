...
public class VduConfigurationBuilder implements Builder<VduConfiguration> {
    ...
    public VduConfigurationBuilder(osm5.ns.yang.nfvo.mano.types.rev170208.VcaConfiguration arg) {
    ...
    public VduConfigurationBuilder(osm5.ns.yang.nfvo.mano.types.rev170208.VcaMetrics arg) {
        this._metrics = arg.getMetrics();
    }
     ...
     * <li>org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.VcaMetrics</li>
     * </ul>
     *
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof osm5.ns.yang.nfvo.mano.types.rev170208.VcaConfiguration) {
            this._configMethod = ((osm5.ns.yang.nfvo.mano.types.rev170208.VcaConfiguration)arg).getConfigMethod();
            this._configPrimitive = ((osm5.ns.yang.nfvo.mano.types.rev170208.VcaConfiguration)arg).getConfigPrimitive();
            this._initialConfigPrimitive = ((osm5.ns.yang.nfvo.mano.types.rev170208.VcaConfiguration)arg).getInitialConfigPrimitive();
            isValidArg = true;
        }
        if (arg instanceof osm5.ns.yang.nfvo.mano.types.rev170208.VcaMetrics) {
            this._metrics = ((osm5.ns.yang.nfvo.mano.types.rev170208.VcaMetrics)arg).getMetrics();
            isValidArg = true;
        }
        CodeHelpers.validValue(isValidArg, arg, "[org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.VcaConfiguration, org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.VcaMetrics]");
    }
