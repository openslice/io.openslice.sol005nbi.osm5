...
public class CloudConfigBuilder implements Builder<CloudConfig> {
    ...
    public CloudConfigBuilder(osm5.ns.yang.nfvo.mano.types.rev170208.CloudConfig arg) {
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof osm5.ns.yang.nfvo.mano.types.rev170208.CloudConfig) {
            this._keyPair = ((osm5.ns.yang.nfvo.mano.types.rev170208.CloudConfig)arg).getKeyPair();
            this._user = ((osm5.ns.yang.nfvo.mano.types.rev170208.CloudConfig)arg).getUser();
            isValidArg = true;
        }
        CodeHelpers.validValue(isValidArg, arg, "[org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.CloudConfig]");
    }
