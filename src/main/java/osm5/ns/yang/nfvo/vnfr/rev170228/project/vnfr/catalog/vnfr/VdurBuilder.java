...
import osm5.ns.yang.nfvo.vnfr.rev170228.VduOperationalStatus;
import osm5.ns.yang.nfvo.vnfr.rev170228.placement.group.info.PlacementGroupsInfo;
import osm5.ns.yang.nfvo.vnfr.rev170228.project.vnfr.catalog.vnfr.vdur.Interface;
import osm5.ns.yang.nfvo.vnfr.rev170228.project.vnfr.catalog.vnfr.vdur.InternalConnectionPoint;
import osm5.ns.yang.nfvo.vnfr.rev170228.project.vnfr.catalog.vnfr.vdur.MonitoringParam;
import osm5.ns.yang.nfvo.vnfr.rev170228.project.vnfr.catalog.vnfr.vdur.VduConfiguration;
import osm5.ns.yang.nfvo.vnfr.rev170228.project.vnfr.catalog.vnfr.vdur.Volumes;
...
/**
 * Class that builds {@link VdurBuilder} instances.
 * 
 * @see VdurBuilder
 *
 */
public class VdurBuilder implements Builder<Vdur> {
    ...
    public VdurBuilder(osm5.ns.yang.nfvo.mano.types.rev170208.GuestEpa arg) {
        this._guestEpa = arg.getGuestEpa();
    }
    public VdurBuilder(osm5.ns.yang.nfvo.mano.types.rev170208.SupplementalBootData arg) {
        this._supplementalBootData = arg.getSupplementalBootData();
    }
    public VdurBuilder(osm5.ns.yang.nfvo.mano.types.rev170208.HostEpa arg) {
        this._hostEpa = arg.getHostEpa();
    }
    public VdurBuilder(osm5.ns.yang.nfvo.mano.types.rev170208.VmFlavor arg) {
        this._vmFlavor = arg.getVmFlavor();
    }
    public VdurBuilder(osm5.ns.yang.nfvo.mano.types.rev170208.VswitchEpa arg) {
        this._vswitchEpa = arg.getVswitchEpa();
    }
    public VdurBuilder(osm5.ns.yang.nfvo.vnfr.rev170228.PlacementGroupInfo arg) {
        this._placementGroupsInfo = arg.getPlacementGroupsInfo();
    }
    public VdurBuilder(osm5.ns.yang.nfvo.mano.types.rev170208.HypervisorEpa arg) {
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof osm5.ns.yang.nfvo.vnfr.rev170228.PlacementGroupInfo) {
            this._placementGroupsInfo = ((osm5.ns.yang.nfvo.vnfr.rev170228.PlacementGroupInfo)arg).getPlacementGroupsInfo();
            isValidArg = true;
        }
        ...
        CodeHelpers.validValue(isValidArg, arg, "[org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.vnfr.rev170228.PlacementGroupInfo, org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.HypervisorEpa, org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.SupplementalBootData, org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.GuestEpa, org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.VswitchEpa, org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.VmFlavor, org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.HostEpa]");
    }
