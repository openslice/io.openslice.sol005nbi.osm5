...
public class VnfMetricBuilder implements Builder<VnfMetric> {
    ...
    private osm5.ns.yang.nfvo.vnfr.rev170228.project.vnfr.catalog.vnfr.monitoring.param.monitoring.type.vnf.metric.VnfMetric _vnfMetric;
    ...
    public osm5.ns.yang.nfvo.vnfr.rev170228.project.vnfr.catalog.vnfr.monitoring.param.monitoring.type.vnf.metric.VnfMetric getVnfMetric() {
        return _vnfMetric;
    }
    ...
    public VnfMetricBuilder setVnfMetric(final osm5.ns.yang.nfvo.vnfr.rev170228.project.vnfr.catalog.vnfr.monitoring.param.monitoring.type.vnf.metric.VnfMetric value) {
    ...
    private static final class VnfMetricImpl implements VnfMetric {
        ...
        private final osm5.ns.yang.nfvo.vnfr.rev170228.project.vnfr.catalog.vnfr.monitoring.param.monitoring.type.vnf.metric.VnfMetric _vnfMetric;
