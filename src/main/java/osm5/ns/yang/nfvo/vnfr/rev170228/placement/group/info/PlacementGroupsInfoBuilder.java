...
import osm5.ns.yang.nfvo.mano.types.rev170208.CloudAccountType;
import osm5.ns.yang.nfvo.mano.types.rev170208.PlacementGroupInfo.Strategy;
...
public class PlacementGroupsInfoBuilder implements Builder<PlacementGroupsInfo> {
    ...
    public PlacementGroupsInfoBuilder(osm5.ns.yang.nfvo.mano.types.rev170208.PlacementGroupInfo arg) {
        this._name = arg.getName();
        this._requirement = arg.getRequirement();
        this._strategy = arg.getStrategy();
    }
    public PlacementGroupsInfoBuilder(osm5.ns.yang.nfvo.mano.types.rev170208.PlacementGroupInput arg) {
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof osm5.ns.yang.nfvo.mano.types.rev170208.PlacementGroupInfo) {
            this._name = ((osm5.ns.yang.nfvo.mano.types.rev170208.PlacementGroupInfo)arg).getName();
            this._requirement = ((osm5.ns.yang.nfvo.mano.types.rev170208.PlacementGroupInfo)arg).getRequirement();
            this._strategy = ((osm5.ns.yang.nfvo.mano.types.rev170208.PlacementGroupInfo)arg).getStrategy();
            isValidArg = true;
        }
        if (arg instanceof osm5.ns.yang.nfvo.mano.types.rev170208.PlacementGroupInput) {
            this._cloudType = ((osm5.ns.yang.nfvo.mano.types.rev170208.PlacementGroupInput)arg).getCloudType();
            this._cloudProvider = ((osm5.ns.yang.nfvo.mano.types.rev170208.PlacementGroupInput)arg).getCloudProvider();
            isValidArg = true;
        }
        CodeHelpers.validValue(isValidArg, arg, "[org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.PlacementGroupInfo, org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.PlacementGroupInput]");
    }
    ...
    private static final class PlacementGroupsInfoImpl implements PlacementGroupsInfo {
        ...
        private final osm5.ns.yang.nfvo.mano.types.rev170208.PlacementGroupInfo.Strategy _strategy;
        ...
        @Override
        public osm5.ns.yang.nfvo.mano.types.rev170208.PlacementGroupInfo.Strategy getStrategy() {
            return _strategy;
        }
