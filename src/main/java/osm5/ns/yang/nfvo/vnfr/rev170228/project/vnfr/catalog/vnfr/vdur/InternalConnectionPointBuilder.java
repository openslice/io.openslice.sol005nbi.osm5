...
/**
 * Class that builds {@link InternalConnectionPointBuilder} instances.
 * 
...
public class InternalConnectionPointBuilder implements Builder<InternalConnectionPoint> {
    ...
    public InternalConnectionPointBuilder(osm5.ns.riftware._1._0.vnfd.base.rev170228.CommonConnectionPoint arg) {
    ...
    public InternalConnectionPointBuilder(osm5.ns.yang.nfvo.vnfr.rev170228.AssociatedVirtualCps arg) {
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof osm5.ns.yang.nfvo.vnfr.rev170228.AssociatedVirtualCps) {
            this._virtualCps = ((osm5.ns.yang.nfvo.vnfr.rev170228.AssociatedVirtualCps)arg).getVirtualCps();
            isValidArg = true;
        }
        ...
        CodeHelpers.validValue(isValidArg, arg, "[org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.vnfr.rev170228.AssociatedVirtualCps, org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.vnfd.base.rev170228.CommonConnectionPoint]");
    }
