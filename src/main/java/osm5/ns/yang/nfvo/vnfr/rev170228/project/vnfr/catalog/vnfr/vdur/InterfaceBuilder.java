...
import osm5.ns.yang.nfvo.vnfr.rev170228.virtual._interface.VirtualInterface;
...
public class InterfaceBuilder implements Builder<Interface> {
    ...
    public InterfaceBuilder(osm5.ns.yang.nfvo.vnfr.rev170228.VirtualInterface arg) {
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof osm5.ns.yang.nfvo.vnfr.rev170228.VirtualInterface) {
            this._virtualInterface = ((osm5.ns.yang.nfvo.vnfr.rev170228.VirtualInterface)arg).getVirtualInterface();
            isValidArg = true;
        }
        CodeHelpers.validValue(isValidArg, arg, "[org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.vnfr.rev170228.VirtualInterface]");
    }
