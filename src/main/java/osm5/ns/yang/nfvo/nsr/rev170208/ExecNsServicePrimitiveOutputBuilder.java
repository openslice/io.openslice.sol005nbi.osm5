...
import osm5.ns.yang.nfvo.mano.types.rev170208.primitive.parameter.value.Parameter;
...
/**
 * Class that builds {@link ExecNsServicePrimitiveOutputBuilder} instances.
 * 
...
public class ExecNsServicePrimitiveOutputBuilder implements Builder<ExecNsServicePrimitiveOutput> {
    ...
    public ExecNsServicePrimitiveOutputBuilder(osm5.ns.yang.nfvo.mano.types.rev170208.PrimitiveParameterValue arg) {
        this._parameter = arg.getParameter();
    }
    public ExecNsServicePrimitiveOutputBuilder(osm5.ns.yang.nfvo.nsr.rev170208.RpcCommon arg) {
        this._nsrIdRef = arg.getNsrIdRef();
        this._projectName = arg.getProjectName();
    }
    public ExecNsServicePrimitiveOutputBuilder(osm5.ns.yang.nfvo.mano.types.rev170208.RpcProjectName arg) {
        this._projectName = arg.getProjectName();
    }
    ...
    public ExecNsServicePrimitiveOutputBuilder(ExecNsServicePrimitiveOutput base) {
        ...
        if (base instanceof ExecNsServicePrimitiveOutputImpl) {
            ...
            Map<Class<? extends Augmentation<ExecNsServicePrimitiveOutput>>, Augmentation<ExecNsServicePrimitiveOutput>> aug =((AugmentationHolder<ExecNsServicePrimitiveOutput>) base).augmentations();
            if (!aug.isEmpty()) {
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof osm5.ns.yang.nfvo.mano.types.rev170208.PrimitiveParameterValue) {
            this._parameter = ((osm5.ns.yang.nfvo.mano.types.rev170208.PrimitiveParameterValue)arg).getParameter();
            isValidArg = true;
        }
        ...
        if (arg instanceof osm5.ns.yang.nfvo.nsr.rev170208.RpcCommon) {
            this._nsrIdRef = ((osm5.ns.yang.nfvo.nsr.rev170208.RpcCommon)arg).getNsrIdRef();
            isValidArg = true;
        }
        CodeHelpers.validValue(isValidArg, arg, "[org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.PrimitiveParameterValue, org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.RpcProjectName, org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nsr.rev170208.RpcCommon]");
    }
    ...
    private static final class ExecNsServicePrimitiveOutputImpl implements ExecNsServicePrimitiveOutput {
        ...
        ExecNsServicePrimitiveOutputImpl(ExecNsServicePrimitiveOutputBuilder base) {
            this._createTime = base.getCreateTime();
            this._jobId = base.getJobId();
            this._jobStatusDetails = base.getJobStatusDetails();
            this._name = base.getName();
