...
import osm5.ns.yang.nfvo.nsr.rev170208.event.service.primitive.Parameter;
...
/**
 * Class that builds {@link InitialServicePrimitiveBuilder} instances.
 * 
...
public class InitialServicePrimitiveBuilder implements Builder<InitialServicePrimitive> {
    ...
    public InitialServicePrimitiveBuilder(osm5.ns.yang.nfvo.nsr.rev170208.EventServicePrimitive arg) {
    ...
    public InitialServicePrimitiveBuilder(InitialServicePrimitive base) {
        ...
        if (base instanceof InitialServicePrimitiveImpl) {
            ...
            Map<Class<? extends Augmentation<InitialServicePrimitive>>, Augmentation<InitialServicePrimitive>> aug =((AugmentationHolder<InitialServicePrimitive>) base).augmentations();
            if (!aug.isEmpty()) {
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof osm5.ns.yang.nfvo.nsr.rev170208.EventServicePrimitive) {
            this._seq = ((osm5.ns.yang.nfvo.nsr.rev170208.EventServicePrimitive)arg).getSeq();
            this._name = ((osm5.ns.yang.nfvo.nsr.rev170208.EventServicePrimitive)arg).getName();
            this._userDefinedScript = ((osm5.ns.yang.nfvo.nsr.rev170208.EventServicePrimitive)arg).getUserDefinedScript();
            this._parameter = ((osm5.ns.yang.nfvo.nsr.rev170208.EventServicePrimitive)arg).getParameter();
            isValidArg = true;
        }
        CodeHelpers.validValue(isValidArg, arg, "[org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nsr.rev170208.EventServicePrimitive]");
    }
    ...
    private static final class InitialServicePrimitiveImpl implements InitialServicePrimitive {
        ...
        InitialServicePrimitiveImpl(InitialServicePrimitiveBuilder base) {
            if (base.key() != null) {
                this.key = base.key();
            } else {
                this.key = new InitialServicePrimitiveKey(base.getSeq());
            }
