...
public class VnfrConnectionPointRefBuilder implements Builder<VnfrConnectionPointRef> {
    ...
    private String _vnfrIngressConnectionPointRef;
    ...
    public String getVnfrIngressConnectionPointRef() {
    ...
    public VnfrConnectionPointRefBuilder setVnfrIngressConnectionPointRef(final String value) {
    ...
    private static final class VnfrConnectionPointRefImpl implements VnfrConnectionPointRef {
        ...
        private final String _vnfrIngressConnectionPointRef;
