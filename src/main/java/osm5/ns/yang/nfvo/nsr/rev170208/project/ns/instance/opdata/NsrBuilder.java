...
import osm5.ns.yang.nfvo.nsr.rev170208.ConfigStates;
import osm5.ns.yang.nfvo.nsr.rev170208.NsOperationalStatus;
import osm5.ns.yang.nfvo.nsr.rev170208.project.ns.instance.opdata.nsr.ConfigAgentJob;
import osm5.ns.yang.nfvo.nsr.rev170208.project.ns.instance.opdata.nsr.ConnectionPoint;
import osm5.ns.yang.nfvo.nsr.rev170208.project.ns.instance.opdata.nsr.ConstituentVnfrRef;
import osm5.ns.yang.nfvo.nsr.rev170208.project.ns.instance.opdata.nsr.InitialServicePrimitive;
import osm5.ns.yang.nfvo.nsr.rev170208.project.ns.instance.opdata.nsr.MonitoringParam;
import osm5.ns.yang.nfvo.nsr.rev170208.project.ns.instance.opdata.nsr.ScalingGroupRecord;
import osm5.ns.yang.nfvo.nsr.rev170208.project.ns.instance.opdata.nsr.ServicePrimitive;
import osm5.ns.yang.nfvo.nsr.rev170208.project.ns.instance.opdata.nsr.TerminateServicePrimitive;
...
public class NsrBuilder implements Builder<Nsr> {
    ...
    public NsrBuilder(osm5.ns.yang.nfvo.nsr.rev170208.Vnffgr arg) {
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof osm5.ns.yang.nfvo.nsr.rev170208.Vnffgr) {
            this._vnffgr = ((osm5.ns.yang.nfvo.nsr.rev170208.Vnffgr)arg).getVnffgr();
            isValidArg = true;
        }
        CodeHelpers.validValue(isValidArg, arg, "[org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nsr.rev170208.Vnffgr]");
    }
