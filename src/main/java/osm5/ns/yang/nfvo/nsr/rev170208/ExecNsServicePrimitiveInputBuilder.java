...
/**
 * Class that builds {@link ExecNsServicePrimitiveInputBuilder} instances.
 * 
...
public class ExecNsServicePrimitiveInputBuilder implements Builder<ExecNsServicePrimitiveInput> {
    ...
    public ExecNsServicePrimitiveInputBuilder(osm5.ns.yang.nfvo.mano.types.rev170208.PrimitiveParameterValue arg) {
        this._parameter = arg.getParameter();
    }
    public ExecNsServicePrimitiveInputBuilder(osm5.ns.yang.nfvo.nsr.rev170208.RpcCommon arg) {
        this._nsrIdRef = arg.getNsrIdRef();
        this._projectName = arg.getProjectName();
    }
    public ExecNsServicePrimitiveInputBuilder(osm5.ns.yang.nfvo.mano.types.rev170208.RpcProjectName arg) {
        this._projectName = arg.getProjectName();
    }
    ...
    public ExecNsServicePrimitiveInputBuilder(ExecNsServicePrimitiveInput base) {
        ...
        if (base instanceof ExecNsServicePrimitiveInputImpl) {
            ...
            Map<Class<? extends Augmentation<ExecNsServicePrimitiveInput>>, Augmentation<ExecNsServicePrimitiveInput>> aug =((AugmentationHolder<ExecNsServicePrimitiveInput>) base).augmentations();
            if (!aug.isEmpty()) {
    ...
    */
    ...
    private static final class ExecNsServicePrimitiveInputImpl implements ExecNsServicePrimitiveInput {
        ...
        ExecNsServicePrimitiveInputImpl(ExecNsServicePrimitiveInputBuilder base) {
            this._name = base.getName();
            this._nsrIdRef = base.getNsrIdRef();
            this._parameter = base.getParameter();
            this._parameterGroup = base.getParameterGroup();
