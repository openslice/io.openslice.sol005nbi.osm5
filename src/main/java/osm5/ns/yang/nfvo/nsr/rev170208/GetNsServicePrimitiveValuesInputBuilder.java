...
/**
 * Class that builds {@link GetNsServicePrimitiveValuesInputBuilder} instances.
 * 
...
public class GetNsServicePrimitiveValuesInputBuilder implements Builder<GetNsServicePrimitiveValuesInput> {
    ...
    public GetNsServicePrimitiveValuesInputBuilder(osm5.ns.yang.nfvo.nsr.rev170208.RpcCommon arg) {
        this._nsrIdRef = arg.getNsrIdRef();
        this._projectName = arg.getProjectName();
    }
    public GetNsServicePrimitiveValuesInputBuilder(osm5.ns.yang.nfvo.mano.types.rev170208.RpcProjectName arg) {
        this._projectName = arg.getProjectName();
    }
    ...
    public GetNsServicePrimitiveValuesInputBuilder(GetNsServicePrimitiveValuesInput base) {
        ...
        if (base instanceof GetNsServicePrimitiveValuesInputImpl) {
            ...
            Map<Class<? extends Augmentation<GetNsServicePrimitiveValuesInput>>, Augmentation<GetNsServicePrimitiveValuesInput>> aug =((AugmentationHolder<GetNsServicePrimitiveValuesInput>) base).augmentations();
            if (!aug.isEmpty()) {
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        CodeHelpers.validValue(isValidArg, arg, "[org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.RpcProjectName, org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nsr.rev170208.RpcCommon]");
    }
    ...
    private static final class GetNsServicePrimitiveValuesInputImpl implements GetNsServicePrimitiveValuesInput {
        ...
        GetNsServicePrimitiveValuesInputImpl(GetNsServicePrimitiveValuesInputBuilder base) {
            this._name = base.getName();
            this._nsrIdRef = base.getNsrIdRef();
            this._projectName = base.getProjectName();
