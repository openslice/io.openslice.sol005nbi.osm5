...
/**
 * Class that builds {@link StartNetworkServiceInputBuilder} instances.
 * 
...
public class StartNetworkServiceInputBuilder implements Builder<StartNetworkServiceInput> {
    ...
    public StartNetworkServiceInputBuilder(osm5.ns.yang.nfvo.mano.types.rev170208.RpcProjectName arg) {
        this._projectName = arg.getProjectName();
    }
    public StartNetworkServiceInputBuilder(osm5.ns.yang.nfvo.nsr.rev170208.NsInstanceConfigParamsCommon arg) {
    ...
    public StartNetworkServiceInputBuilder(osm5.ns.yang.nfvo.mano.types.rev170208.InputParameter arg) {
        this._inputParameter = arg.getInputParameter();
    }
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof osm5.ns.yang.nfvo.mano.types.rev170208.RpcProjectName) {
            this._projectName = ((osm5.ns.yang.nfvo.mano.types.rev170208.RpcProjectName)arg).getProjectName();
            isValidArg = true;
        }
        ...
        CodeHelpers.validValue(isValidArg, arg, "[org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.RpcProjectName, org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nsr.rev170208.NsInstanceConfigParamsCommon, org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.InputParameter]");
    }
