 ...
 * =========================LICENSE_END==================================
 */
package osm5.ns.yang.nfvo.nsr.rev170208.project.ns.instance.config;
import com.google.common.base.MoreObjects;
import com.google.common.collect.ImmutableMap;

import osm5.ns.yang.ietf.yang.types.rev130715.Uuid;
import osm5.ns.yang.nfvo.mano.types.rev170208.input.parameter.InputParameter;
...
import osm5.ns.yang.nfvo.nsr.rev170208.ns.instance.config.params.common.NsdPlacementGroupMaps;
import osm5.ns.yang.nfvo.nsr.rev170208.ns.instance.config.params.common.ScalingGroup;
import osm5.ns.yang.nfvo.nsr.rev170208.project.ns.instance.config.nsr.Nsd;
...
public class NsrBuilder implements Builder<Nsr> {
    ...
    public NsrBuilder(osm5.ns.yang.nfvo.nsr.rev170208.NsInstanceConfigParams arg) {
    ...
    public NsrBuilder(osm5.ns.yang.nfvo.nsr.rev170208.NsInstanceConfigParamsCommon arg) {
        this._scalingGroup = arg.getScalingGroup();
        this._nsdPlacementGroupMaps = arg.getNsdPlacementGroupMaps();
        this._inputParameter = arg.getInputParameter();
    }
    public NsrBuilder(osm5.ns.yang.nfvo.mano.types.rev170208.InputParameter arg) {
        this._inputParameter = arg.getInputParameter();
    }
    public NsrBuilder(osm5.ns.yang.nfvo.nsr.rev170208.CloudConfig arg) {
        this._sshAuthorizedKey = arg.getSshAuthorizedKey();
        this._user = arg.getUser();
    }
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof osm5.ns.yang.nfvo.nsr.rev170208.CloudConfig) {
            this._sshAuthorizedKey = ((osm5.ns.yang.nfvo.nsr.rev170208.CloudConfig)arg).getSshAuthorizedKey();
            this._user = ((osm5.ns.yang.nfvo.nsr.rev170208.CloudConfig)arg).getUser();
            isValidArg = true;
        }
        if (arg instanceof osm5.ns.yang.nfvo.nsr.rev170208.NsInstanceConfigParams) {
            this._vnfdPlacementGroupMaps = ((osm5.ns.yang.nfvo.nsr.rev170208.NsInstanceConfigParams)arg).getVnfdPlacementGroupMaps();
            isValidArg = true;
        }
        if (arg instanceof osm5.ns.yang.nfvo.nsr.rev170208.NsInstanceConfigParamsCommon) {
            this._scalingGroup = ((osm5.ns.yang.nfvo.nsr.rev170208.NsInstanceConfigParamsCommon)arg).getScalingGroup();
            this._nsdPlacementGroupMaps = ((osm5.ns.yang.nfvo.nsr.rev170208.NsInstanceConfigParamsCommon)arg).getNsdPlacementGroupMaps();
            isValidArg = true;
        }
        if (arg instanceof osm5.ns.yang.nfvo.mano.types.rev170208.InputParameter) {
            this._inputParameter = ((osm5.ns.yang.nfvo.mano.types.rev170208.InputParameter)arg).getInputParameter();
            isValidArg = true;
        }
        CodeHelpers.validValue(isValidArg, arg, "[org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nsr.rev170208.CloudConfig, org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nsr.rev170208.NsInstanceConfigParams, org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nsr.rev170208.NsInstanceConfigParamsCommon, org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.InputParameter]");
    }
