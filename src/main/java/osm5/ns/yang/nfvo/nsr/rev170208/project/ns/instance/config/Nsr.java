...
public interface Nsr
    extends
    ChildOf<NsInstanceConfig>,
    Augmentable<Nsr>,
    NsInstanceConfigParams,
    Identifiable<NsrKey>
{
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nsr.rev170208.project.ns.instance.config.Nsr.AdminStatus</code> <code>adminStatus</code>, or <code>null</code> if not present
     */
    @Nullable
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.nsr.rev170208.project.ns.instance.config.nsr.Nsd</code> <code>nsd</code>, or <code>null</code> if not present
     */
    @Nullable
    Nsd getNsd();
