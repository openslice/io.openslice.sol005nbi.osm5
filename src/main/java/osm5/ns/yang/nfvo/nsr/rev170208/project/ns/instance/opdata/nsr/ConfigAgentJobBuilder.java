...
import osm5.ns.yang.nfvo.nsr.rev170208.TriggerType;
import osm5.ns.yang.nfvo.nsr.rev170208.project.ns.instance.opdata.nsr.config.agent.job.ParameterGroup;
import osm5.ns.yang.nfvo.nsr.rev170208.project.ns.instance.opdata.nsr.config.agent.job.Vnfr;
...
/**
 * Class that builds {@link ConfigAgentJobBuilder} instances.
 * 
...
public class ConfigAgentJobBuilder implements Builder<ConfigAgentJob> {
    ...
    public ConfigAgentJobBuilder(osm5.ns.yang.nfvo.mano.types.rev170208.PrimitiveParameterValue arg) {
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        CodeHelpers.validValue(isValidArg, arg, "[org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.PrimitiveParameterValue]");
    }
