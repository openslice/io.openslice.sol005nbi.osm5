 ...
 * =========================LICENSE_END==================================
 */
package osm5.ns.yang.nfvo.nsr.rev170208.vnffgr;
...
import osm5.ns.yang.nfvo.nsr.rev170208.VnffgrOperationalStatus;
import osm5.ns.yang.nfvo.nsr.rev170208.vnffgr.vnffgr.Classifier;
...
public interface Vnffgr
    extends
    ChildOf<osm5.ns.yang.nfvo.nsr.rev170208.Vnffgr>,
    Augmentable<Vnffgr>,
