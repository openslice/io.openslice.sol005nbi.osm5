...
/**
 * Class that builds {@link ExecScaleInInputBuilder} instances.
 * 
...
public class ExecScaleInInputBuilder implements Builder<ExecScaleInInput> {
    ...
    public ExecScaleInInputBuilder(osm5.ns.yang.nfvo.nsr.rev170208.RpcCommon arg) {
        this._nsrIdRef = arg.getNsrIdRef();
        this._projectName = arg.getProjectName();
    }
    public ExecScaleInInputBuilder(osm5.ns.yang.nfvo.mano.types.rev170208.RpcProjectName arg) {
        this._projectName = arg.getProjectName();
    }
