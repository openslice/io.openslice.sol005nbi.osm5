    ...
    RpcService
{
     ...
     *
     *
     * @return <code>com.google.common.util.concurrent.ListenableFuture</code> <code>nsServicePrimitiveValues</code>, or <code>null</code> if not present
     */
    @CheckReturnValue
    ListenableFuture<RpcResult<GetNsServicePrimitiveValuesOutput>> getNsServicePrimitiveValues(GetNsServicePrimitiveValuesInput input);
