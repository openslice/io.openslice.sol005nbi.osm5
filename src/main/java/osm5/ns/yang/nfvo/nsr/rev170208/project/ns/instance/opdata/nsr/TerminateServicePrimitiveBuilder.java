...
/**
 * Class that builds {@link TerminateServicePrimitiveBuilder} instances.
 * 
...
public class TerminateServicePrimitiveBuilder implements Builder<TerminateServicePrimitive> {
    ...
    public TerminateServicePrimitiveBuilder(osm5.ns.yang.nfvo.nsr.rev170208.EventServicePrimitive arg) {
    ...
    public TerminateServicePrimitiveBuilder(TerminateServicePrimitive base) {
        ...
        if (base instanceof TerminateServicePrimitiveImpl) {
            ...
            Map<Class<? extends Augmentation<TerminateServicePrimitive>>, Augmentation<TerminateServicePrimitive>> aug =((AugmentationHolder<TerminateServicePrimitive>) base).augmentations();
            if (!aug.isEmpty()) {
    ...
    */
    ...
    private static final class TerminateServicePrimitiveImpl implements TerminateServicePrimitive {
        ...
        TerminateServicePrimitiveImpl(TerminateServicePrimitiveBuilder base) {
            if (base.key() != null) {
                this.key = base.key();
            } else {
