...
/**
 * Class that builds {@link ExecScaleOutInputBuilder} instances.
 * 
...
public class ExecScaleOutInputBuilder implements Builder<ExecScaleOutInput> {
    ...
    public ExecScaleOutInputBuilder(osm5.ns.yang.nfvo.nsr.rev170208.RpcCommon arg) {
        this._nsrIdRef = arg.getNsrIdRef();
        this._projectName = arg.getProjectName();
    }
    public ExecScaleOutInputBuilder(osm5.ns.yang.nfvo.mano.types.rev170208.RpcProjectName arg) {
        this._projectName = arg.getProjectName();
    }
