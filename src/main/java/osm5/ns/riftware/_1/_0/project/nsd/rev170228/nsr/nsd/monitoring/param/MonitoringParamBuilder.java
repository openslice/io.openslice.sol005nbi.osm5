 ...
 * =========================LICENSE_END==================================
 */
package osm5.ns.riftware._1._0.project.nsd.rev170228.nsr.nsd.monitoring.param;
import com.google.common.base.MoreObjects;
import com.google.common.collect.ImmutableMap;

import osm5.ns.riftware._1._0.project.nsd.rev170228.nsr.nsd.monitoring.param.monitoring.param.VnfdMonitoringParam;
import osm5.ns.yang.nfvo.mano.types.rev170208.ParamValueType;
import osm5.ns.yang.nfvo.mano.types.rev170208.WidgetType;
import osm5.ns.yang.nfvo.mano.types.rev170208.MonitoringParamAggregation.AggregationType;
import osm5.ns.yang.nfvo.mano.types.rev170208.monitoring.param.value.NumericConstraints;
import osm5.ns.yang.nfvo.mano.types.rev170208.monitoring.param.value.TextConstraints;
...
public class MonitoringParamBuilder implements Builder<MonitoringParam> {
    ...
    public MonitoringParamBuilder(osm5.ns.riftware._1._0.nsd.base.rev170228.MonitoringParamCommon arg) {
        this._id = arg.getId();
    ...
    public MonitoringParamBuilder(osm5.ns.yang.nfvo.mano.types.rev170208.MonitoringParamUiData arg) {
        this._description = arg.getDescription();
        this._groupTag = arg.getGroupTag();
        this._widgetType = arg.getWidgetType();
        this._units = arg.getUnits();
    }
    public MonitoringParamBuilder(osm5.ns.yang.nfvo.mano.types.rev170208.MonitoringParamAggregation arg) {
        this._aggregationType = arg.getAggregationType();
    }
    public MonitoringParamBuilder(osm5.ns.yang.nfvo.mano.types.rev170208.MonitoringParamValue arg) {
        this._valueType = arg.getValueType();
        this._numericConstraints = arg.getNumericConstraints();
        this._textConstraints = arg.getTextConstraints();
        this._valueInteger = arg.getValueInteger();
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof osm5.ns.yang.nfvo.mano.types.rev170208.MonitoringParamValue) {
            this._valueType = ((osm5.ns.yang.nfvo.mano.types.rev170208.MonitoringParamValue)arg).getValueType();
            this._numericConstraints = ((osm5.ns.yang.nfvo.mano.types.rev170208.MonitoringParamValue)arg).getNumericConstraints();
            this._textConstraints = ((osm5.ns.yang.nfvo.mano.types.rev170208.MonitoringParamValue)arg).getTextConstraints();
            this._valueInteger = ((osm5.ns.yang.nfvo.mano.types.rev170208.MonitoringParamValue)arg).getValueInteger();
            this._valueDecimal = ((osm5.ns.yang.nfvo.mano.types.rev170208.MonitoringParamValue)arg).getValueDecimal();
            this._valueString = ((osm5.ns.yang.nfvo.mano.types.rev170208.MonitoringParamValue)arg).getValueString();
            isValidArg = true;
        }
        if (arg instanceof osm5.ns.riftware._1._0.nsd.base.rev170228.MonitoringParamCommon) {
            this._id = ((osm5.ns.riftware._1._0.nsd.base.rev170228.MonitoringParamCommon)arg).getId();
            this._name = ((osm5.ns.riftware._1._0.nsd.base.rev170228.MonitoringParamCommon)arg).getName();
            isValidArg = true;
        }
        if (arg instanceof osm5.ns.yang.nfvo.mano.types.rev170208.MonitoringParamUiData) {
            this._description = ((osm5.ns.yang.nfvo.mano.types.rev170208.MonitoringParamUiData)arg).getDescription();
            this._groupTag = ((osm5.ns.yang.nfvo.mano.types.rev170208.MonitoringParamUiData)arg).getGroupTag();
            this._widgetType = ((osm5.ns.yang.nfvo.mano.types.rev170208.MonitoringParamUiData)arg).getWidgetType();
            this._units = ((osm5.ns.yang.nfvo.mano.types.rev170208.MonitoringParamUiData)arg).getUnits();
            isValidArg = true;
        }
        if (arg instanceof osm5.ns.yang.nfvo.mano.types.rev170208.MonitoringParamAggregation) {
            this._aggregationType = ((osm5.ns.yang.nfvo.mano.types.rev170208.MonitoringParamAggregation)arg).getAggregationType();
            isValidArg = true;
        }
        CodeHelpers.validValue(isValidArg, arg, "[org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.MonitoringParamValue, org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.nsd.base.rev170228.MonitoringParamCommon, org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.MonitoringParamUiData, org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.MonitoringParamAggregation]");
    }
    ...
    private static final class MonitoringParamImpl implements MonitoringParam {
        ...
        private final osm5.ns.yang.nfvo.mano.types.rev170208.MonitoringParamAggregation.AggregationType _aggregationType;
        ...
        @Override
        public osm5.ns.yang.nfvo.mano.types.rev170208.MonitoringParamAggregation.AggregationType getAggregationType() {
            return _aggregationType;
        }
