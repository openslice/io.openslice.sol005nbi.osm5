 ...
 * =========================LICENSE_END==================================
 */
package osm5.ns.riftware._1._0.vnfd.base.rev170228.vnfd.descriptor.monitoring.param;
...
/**
 * Class that builds {@link JsonQueryParamsBuilder} instances.
 * 
...
public class JsonQueryParamsBuilder implements Builder<JsonQueryParams> {
    ...
    private static final class JsonQueryParamsImpl implements JsonQueryParams {
        ...
        private Map<Class<? extends Augmentation<JsonQueryParams>>, Augmentation<JsonQueryParams>> augmentation = Collections.emptyMap();
        ...
        public boolean equals(Object obj) {
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<Class<? extends Augmentation<JsonQueryParams>>, Augmentation<JsonQueryParams>> e : augmentation.entrySet()) {
