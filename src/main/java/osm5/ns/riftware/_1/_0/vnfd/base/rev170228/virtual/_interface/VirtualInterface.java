 ...
 * =========================LICENSE_END==================================
 */
package osm5.ns.riftware._1._0.vnfd.base.rev170228.virtual._interface;
...
public interface VirtualInterface
    extends
    ChildOf<osm5.ns.riftware._1._0.vnfd.base.rev170228.VirtualInterface>,
    Augmentable<VirtualInterface>
{
    ...
    /**
     * Specifies the type of virtual interfacebetween VM and host.PARAVIRT : Use the 
     ...
     * interface.RTL8139 : Emulate RTL8139 interface.PCNET : Emulate PCNET 
     * interface.OM-MGMT : Deprecated! Use PARAVIRT instead and set the VNF management 
     * interface at vnfd:mgmt-interface:cp
     *
     *
     *
