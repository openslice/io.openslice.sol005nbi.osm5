...
import osm5.ns.yang.nfvo.mano.types.rev170208.VolumeInfo.DeviceBus;
import osm5.ns.yang.nfvo.mano.types.rev170208.VolumeInfo.DeviceType;
...
public class VolumesBuilder implements Builder<Volumes> {
    ...
    public VolumesBuilder(osm5.ns.yang.nfvo.mano.types.rev170208.VolumeInfo arg) {
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof osm5.ns.yang.nfvo.mano.types.rev170208.VolumeInfo) {
            this._description = ((osm5.ns.yang.nfvo.mano.types.rev170208.VolumeInfo)arg).getDescription();
            this._size = ((osm5.ns.yang.nfvo.mano.types.rev170208.VolumeInfo)arg).getSize();
            this._volumeSource = ((osm5.ns.yang.nfvo.mano.types.rev170208.VolumeInfo)arg).getVolumeSource();
            this._deviceBus = ((osm5.ns.yang.nfvo.mano.types.rev170208.VolumeInfo)arg).getDeviceBus();
            this._deviceType = ((osm5.ns.yang.nfvo.mano.types.rev170208.VolumeInfo)arg).getDeviceType();
            isValidArg = true;
        }
        CodeHelpers.validValue(isValidArg, arg, "[org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.VolumeInfo]");
    }
    ...
    private static final class VolumesImpl implements Volumes {
        ...
        private final osm5.ns.yang.nfvo.mano.types.rev170208.VolumeInfo.DeviceBus _deviceBus;
        private final osm5.ns.yang.nfvo.mano.types.rev170208.VolumeInfo.DeviceType _deviceType;
        ...
        @Override
        public osm5.ns.yang.nfvo.mano.types.rev170208.VolumeInfo.DeviceBus getDeviceBus() {
            return _deviceBus;
        }
        
        @Override
        public osm5.ns.yang.nfvo.mano.types.rev170208.VolumeInfo.DeviceType getDeviceType() {
            return _deviceType;
        }
