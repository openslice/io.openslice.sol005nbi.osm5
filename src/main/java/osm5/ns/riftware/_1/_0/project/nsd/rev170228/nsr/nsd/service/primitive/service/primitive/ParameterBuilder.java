 ...
 * =========================LICENSE_END==================================
 */
package osm5.ns.riftware._1._0.project.nsd.rev170228.nsr.nsd.service.primitive.service.primitive;
...
/**
 * Class that builds {@link ParameterBuilder} instances.
 * 
...
public class ParameterBuilder implements Builder<Parameter> {
    ...
    public ParameterBuilder(osm5.ns.yang.nfvo.mano.types.rev170208.PrimitiveParameter arg) {
     ...
     * <ul>
     * <li>org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.PrimitiveParameter</li>
     * </ul>
     *
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof osm5.ns.yang.nfvo.mano.types.rev170208.PrimitiveParameter) {
            this._name = ((osm5.ns.yang.nfvo.mano.types.rev170208.PrimitiveParameter)arg).getName();
            this._dataType = ((osm5.ns.yang.nfvo.mano.types.rev170208.PrimitiveParameter)arg).getDataType();
            this._mandatory = ((osm5.ns.yang.nfvo.mano.types.rev170208.PrimitiveParameter)arg).isMandatory();
            this._defaultValue = ((osm5.ns.yang.nfvo.mano.types.rev170208.PrimitiveParameter)arg).getDefaultValue();
            this._parameterPool = ((osm5.ns.yang.nfvo.mano.types.rev170208.PrimitiveParameter)arg).getParameterPool();
            this._readOnly = ((osm5.ns.yang.nfvo.mano.types.rev170208.PrimitiveParameter)arg).isReadOnly();
            this._hidden = ((osm5.ns.yang.nfvo.mano.types.rev170208.PrimitiveParameter)arg).isHidden();
            isValidArg = true;
        }
        CodeHelpers.validValue(isValidArg, arg, "[org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.PrimitiveParameter]");
    }
