...
import osm5.ns.yang.nfvo.mano.types.rev170208.AlarmMetricType;
import osm5.ns.yang.nfvo.mano.types.rev170208.AlarmSeverityType;
import osm5.ns.yang.nfvo.mano.types.rev170208.AlarmStatisticType;
...
public class AlarmBuilder implements Builder<Alarm> {
    ...
    public AlarmBuilder(osm5.ns.yang.nfvo.mano.types.rev170208.Alarm arg) {
     ...
     * <ul>
     * <li>org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.Alarm</li>
     * </ul>
     *
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof osm5.ns.yang.nfvo.mano.types.rev170208.Alarm) {
            this._alarmId = ((osm5.ns.yang.nfvo.mano.types.rev170208.Alarm)arg).getAlarmId();
            this._name = ((osm5.ns.yang.nfvo.mano.types.rev170208.Alarm)arg).getName();
            this._description = ((osm5.ns.yang.nfvo.mano.types.rev170208.Alarm)arg).getDescription();
            this._vdurId = ((osm5.ns.yang.nfvo.mano.types.rev170208.Alarm)arg).getVdurId();
            this._actions = ((osm5.ns.yang.nfvo.mano.types.rev170208.Alarm)arg).getActions();
            this._repeat = ((osm5.ns.yang.nfvo.mano.types.rev170208.Alarm)arg).isRepeat();
            this._enabled = ((osm5.ns.yang.nfvo.mano.types.rev170208.Alarm)arg).isEnabled();
            this._severity = ((osm5.ns.yang.nfvo.mano.types.rev170208.Alarm)arg).getSeverity();
            this._metric = ((osm5.ns.yang.nfvo.mano.types.rev170208.Alarm)arg).getMetric();
            this._statistic = ((osm5.ns.yang.nfvo.mano.types.rev170208.Alarm)arg).getStatistic();
            this._operation = ((osm5.ns.yang.nfvo.mano.types.rev170208.Alarm)arg).getOperation();
            this._value = ((osm5.ns.yang.nfvo.mano.types.rev170208.Alarm)arg).getValue();
            this._period = ((osm5.ns.yang.nfvo.mano.types.rev170208.Alarm)arg).getPeriod();
            this._evaluations = ((osm5.ns.yang.nfvo.mano.types.rev170208.Alarm)arg).getEvaluations();
            isValidArg = true;
        }
        CodeHelpers.validValue(isValidArg, arg, "[org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.Alarm]");
    }
