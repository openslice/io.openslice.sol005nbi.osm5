...
import osm5.ns.riftware._1._0.vnfd.base.rev170228.vnfd.descriptor.vdu.Alarm;
import osm5.ns.riftware._1._0.vnfd.base.rev170228.vnfd.descriptor.vdu.AlternativeImages;
import osm5.ns.riftware._1._0.vnfd.base.rev170228.vnfd.descriptor.vdu.CloudInitInput;
import osm5.ns.riftware._1._0.vnfd.base.rev170228.vnfd.descriptor.vdu.Interface;
import osm5.ns.riftware._1._0.vnfd.base.rev170228.vnfd.descriptor.vdu.InternalConnectionPoint;
import osm5.ns.riftware._1._0.vnfd.base.rev170228.vnfd.descriptor.vdu.MonitoringParam;
import osm5.ns.riftware._1._0.vnfd.base.rev170228.vnfd.descriptor.vdu.VduConfiguration;
import osm5.ns.riftware._1._0.vnfd.base.rev170228.vnfd.descriptor.vdu.Volumes;
...
import osm5.ns.yang.nfvo.mano.types.rev170208.hypervisor.epa.HypervisorEpa;
import osm5.ns.yang.nfvo.mano.types.rev170208.supplemental.boot.data.SupplementalBootData;
import osm5.ns.yang.nfvo.mano.types.rev170208.vm.flavor.VmFlavor;
import osm5.ns.yang.nfvo.mano.types.rev170208.vswitch.epa.VswitchEpa;
...
public class VduBuilder implements Builder<Vdu> {
    ...
    public VduBuilder(osm5.ns.yang.nfvo.mano.types.rev170208.GuestEpa arg) {
        this._guestEpa = arg.getGuestEpa();
    }
    public VduBuilder(osm5.ns.yang.nfvo.mano.types.rev170208.SupplementalBootData arg) {
        this._supplementalBootData = arg.getSupplementalBootData();
    }
    public VduBuilder(osm5.ns.yang.nfvo.mano.types.rev170208.HostEpa arg) {
        this._hostEpa = arg.getHostEpa();
    }
    public VduBuilder(osm5.ns.yang.nfvo.mano.types.rev170208.VmFlavor arg) {
        this._vmFlavor = arg.getVmFlavor();
    }
    public VduBuilder(osm5.ns.yang.nfvo.mano.types.rev170208.ImageProperties arg) {
        this._image = arg.getImage();
        this._imageChecksum = arg.getImageChecksum();
    }
    public VduBuilder(osm5.ns.yang.nfvo.mano.types.rev170208.VswitchEpa arg) {
        this._vswitchEpa = arg.getVswitchEpa();
    }
    public VduBuilder(osm5.ns.yang.nfvo.mano.types.rev170208.HypervisorEpa arg) {
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof osm5.ns.yang.nfvo.mano.types.rev170208.ImageProperties) {
            this._image = ((osm5.ns.yang.nfvo.mano.types.rev170208.ImageProperties)arg).getImage();
            this._imageChecksum = ((osm5.ns.yang.nfvo.mano.types.rev170208.ImageProperties)arg).getImageChecksum();
            isValidArg = true;
        }
        if (arg instanceof osm5.ns.yang.nfvo.mano.types.rev170208.HypervisorEpa) {
            this._hypervisorEpa = ((osm5.ns.yang.nfvo.mano.types.rev170208.HypervisorEpa)arg).getHypervisorEpa();
            isValidArg = true;
        }
        if (arg instanceof osm5.ns.yang.nfvo.mano.types.rev170208.SupplementalBootData) {
            this._supplementalBootData = ((osm5.ns.yang.nfvo.mano.types.rev170208.SupplementalBootData)arg).getSupplementalBootData();
            isValidArg = true;
        }
        if (arg instanceof osm5.ns.yang.nfvo.mano.types.rev170208.GuestEpa) {
            this._guestEpa = ((osm5.ns.yang.nfvo.mano.types.rev170208.GuestEpa)arg).getGuestEpa();
            isValidArg = true;
        }
        if (arg instanceof osm5.ns.yang.nfvo.mano.types.rev170208.VswitchEpa) {
            this._vswitchEpa = ((osm5.ns.yang.nfvo.mano.types.rev170208.VswitchEpa)arg).getVswitchEpa();
            isValidArg = true;
        }
        if (arg instanceof osm5.ns.yang.nfvo.mano.types.rev170208.VmFlavor) {
            this._vmFlavor = ((osm5.ns.yang.nfvo.mano.types.rev170208.VmFlavor)arg).getVmFlavor();
            isValidArg = true;
        }
        if (arg instanceof osm5.ns.yang.nfvo.mano.types.rev170208.HostEpa) {
            this._hostEpa = ((osm5.ns.yang.nfvo.mano.types.rev170208.HostEpa)arg).getHostEpa();
            isValidArg = true;
        }
        CodeHelpers.validValue(isValidArg, arg, "[org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.ImageProperties, org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.HypervisorEpa, org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.SupplementalBootData, org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.GuestEpa, org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.VswitchEpa, org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.VmFlavor, org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.HostEpa]");
    }
