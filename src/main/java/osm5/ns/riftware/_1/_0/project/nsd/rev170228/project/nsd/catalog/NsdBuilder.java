...
import osm5.ns.riftware._1._0.project.nsd.rev170228.nsd.vld.Vld;
import osm5.ns.riftware._1._0.project.nsd.rev170228.nsd.vnf.dependency.VnfDependency;
import osm5.ns.yang.nfvo.mano.types.rev170208.input.parameter.xpath.InputParameterXpath;
...
public class NsdBuilder implements Builder<Nsd> {
    ...
    public NsdBuilder(osm5.ns.riftware._1._0.project.nsd.rev170228.NsdMonitoringParam arg) {
        this._monitoringParam = arg.getMonitoringParam();
    }
    public NsdBuilder(osm5.ns.riftware._1._0.project.nsd.rev170228.NsdVnfDependency arg) {
        this._vnfDependency = arg.getVnfDependency();
    }
    public NsdBuilder(osm5.ns.riftware._1._0.project.nsd.rev170228.NsdVld arg) {
        this._vld = arg.getVld();
    }
    public NsdBuilder(osm5.ns.riftware._1._0.project.nsd.rev170228.NsdConstituentVnfd arg) {
        this._constituentVnfd = arg.getConstituentVnfd();
    }
    public NsdBuilder(osm5.ns.riftware._1._0.project.nsd.rev170228.NsdPlacementGroups arg) {
        this._placementGroups = arg.getPlacementGroups();
    }
    public NsdBuilder(osm5.ns.riftware._1._0.project.nsd.rev170228.NsdServicePrimitive arg) {
        this._servicePrimitive = arg.getServicePrimitive();
    }
    public NsdBuilder(osm5.ns.riftware._1._0.nsd.base.rev170228.NsdDescriptorCommon arg) {
        this._id = arg.getId();
    ...
    public NsdBuilder(osm5.ns.yang.nfvo.mano.types.rev170208.IpProfileList arg) {
        this._ipProfiles = arg.getIpProfiles();
    }
    public NsdBuilder(osm5.ns.yang.nfvo.mano.types.rev170208.InputParameterXpath arg) {
        this._inputParameterXpath = arg.getInputParameterXpath();
    }
     ...
     * <li>org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.project.nsd.rev170228.NsdConstituentVnfd</li>
     * <li>org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.project.nsd.rev170228.NsdMonitoringParam</li>
     * <li>org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.project.nsd.rev170228.NsdServicePrimitive</li>
     * <li>org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.IpProfileList</li>
     * <li>org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.project.nsd.rev170228.NsdVld</li>
     * <li>org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.project.nsd.rev170228.NsdVnfDependency</li>
     * <li>org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.project.nsd.rev170228.NsdPlacementGroups</li>
     * </ul>
     *
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof osm5.ns.riftware._1._0.nsd.base.rev170228.NsdDescriptorCommon) {
            this._id = ((osm5.ns.riftware._1._0.nsd.base.rev170228.NsdDescriptorCommon)arg).getId();
            this._name = ((osm5.ns.riftware._1._0.nsd.base.rev170228.NsdDescriptorCommon)arg).getName();
            this._shortName = ((osm5.ns.riftware._1._0.nsd.base.rev170228.NsdDescriptorCommon)arg).getShortName();
            this._vendor = ((osm5.ns.riftware._1._0.nsd.base.rev170228.NsdDescriptorCommon)arg).getVendor();
            this._logo = ((osm5.ns.riftware._1._0.nsd.base.rev170228.NsdDescriptorCommon)arg).getLogo();
            this._description = ((osm5.ns.riftware._1._0.nsd.base.rev170228.NsdDescriptorCommon)arg).getDescription();
            this._version = ((osm5.ns.riftware._1._0.nsd.base.rev170228.NsdDescriptorCommon)arg).getVersion();
            this._connectionPoint = ((osm5.ns.riftware._1._0.nsd.base.rev170228.NsdDescriptorCommon)arg).getConnectionPoint();
            this._scalingGroupDescriptor = ((osm5.ns.riftware._1._0.nsd.base.rev170228.NsdDescriptorCommon)arg).getScalingGroupDescriptor();
            this._vnffgd = ((osm5.ns.riftware._1._0.nsd.base.rev170228.NsdDescriptorCommon)arg).getVnffgd();
            this._initialServicePrimitive = ((osm5.ns.riftware._1._0.nsd.base.rev170228.NsdDescriptorCommon)arg).getInitialServicePrimitive();
            this._terminateServicePrimitive = ((osm5.ns.riftware._1._0.nsd.base.rev170228.NsdDescriptorCommon)arg).getTerminateServicePrimitive();
            this._parameterPool = ((osm5.ns.riftware._1._0.nsd.base.rev170228.NsdDescriptorCommon)arg).getParameterPool();
            this._keyPair = ((osm5.ns.riftware._1._0.nsd.base.rev170228.NsdDescriptorCommon)arg).getKeyPair();
            this._user = ((osm5.ns.riftware._1._0.nsd.base.rev170228.NsdDescriptorCommon)arg).getUser();
            isValidArg = true;
        }
        if (arg instanceof osm5.ns.yang.nfvo.mano.types.rev170208.InputParameterXpath) {
            this._inputParameterXpath = ((osm5.ns.yang.nfvo.mano.types.rev170208.InputParameterXpath)arg).getInputParameterXpath();
            isValidArg = true;
        }
        if (arg instanceof osm5.ns.riftware._1._0.project.nsd.rev170228.NsdConstituentVnfd) {
            this._constituentVnfd = ((osm5.ns.riftware._1._0.project.nsd.rev170228.NsdConstituentVnfd)arg).getConstituentVnfd();
            isValidArg = true;
        }
        if (arg instanceof osm5.ns.riftware._1._0.project.nsd.rev170228.NsdMonitoringParam) {
            this._monitoringParam = ((osm5.ns.riftware._1._0.project.nsd.rev170228.NsdMonitoringParam)arg).getMonitoringParam();
            isValidArg = true;
        }
        if (arg instanceof osm5.ns.riftware._1._0.project.nsd.rev170228.NsdServicePrimitive) {
            this._servicePrimitive = ((osm5.ns.riftware._1._0.project.nsd.rev170228.NsdServicePrimitive)arg).getServicePrimitive();
            isValidArg = true;
        }
        if (arg instanceof osm5.ns.yang.nfvo.mano.types.rev170208.IpProfileList) {
            this._ipProfiles = ((osm5.ns.yang.nfvo.mano.types.rev170208.IpProfileList)arg).getIpProfiles();
            isValidArg = true;
        }
        if (arg instanceof osm5.ns.riftware._1._0.project.nsd.rev170228.NsdVld) {
            this._vld = ((osm5.ns.riftware._1._0.project.nsd.rev170228.NsdVld)arg).getVld();
            isValidArg = true;
        }
        if (arg instanceof osm5.ns.riftware._1._0.project.nsd.rev170228.NsdVnfDependency) {
            this._vnfDependency = ((osm5.ns.riftware._1._0.project.nsd.rev170228.NsdVnfDependency)arg).getVnfDependency();
            isValidArg = true;
        }
        if (arg instanceof osm5.ns.riftware._1._0.project.nsd.rev170228.NsdPlacementGroups) {
            this._placementGroups = ((osm5.ns.riftware._1._0.project.nsd.rev170228.NsdPlacementGroups)arg).getPlacementGroups();
            isValidArg = true;
        }
        CodeHelpers.validValue(isValidArg, arg, "[org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.nsd.base.rev170228.NsdDescriptorCommon, org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.InputParameterXpath, org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.project.nsd.rev170228.NsdConstituentVnfd, org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.project.nsd.rev170228.NsdMonitoringParam, org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.project.nsd.rev170228.NsdServicePrimitive, org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.IpProfileList, org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.project.nsd.rev170228.NsdVld, org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.project.nsd.rev170228.NsdVnfDependency, org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.project.nsd.rev170228.NsdPlacementGroups]");
    }
