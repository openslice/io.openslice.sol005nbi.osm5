...
import osm5.ns.riftware._1._0.vnfd.base.rev170228.VnfOperationalStatus;
import osm5.ns.riftware._1._0.vnfd.base.rev170228.VnfdDescriptor.ServiceFunctionChain;
import osm5.ns.riftware._1._0.vnfd.base.rev170228.vnfd.descriptor.ConnectionPoint;
...
import osm5.ns.riftware._1._0.vnfd.base.rev170228.vnfd.descriptor.VduDependency;
import osm5.ns.riftware._1._0.vnfd.base.rev170228.vnfd.descriptor.VnfConfiguration;
...
public class VnfdBuilder implements Builder<Vnfd> {
    ...
    public VnfdBuilder(osm5.ns.riftware._1._0.vnfd.base.rev170228.VnfdDescriptor arg) {
        this._id = arg.getId();
    ...
    public VnfdBuilder(osm5.ns.yang.nfvo.mano.types.rev170208.IpProfileList arg) {
        this._ipProfiles = arg.getIpProfiles();
    }
    public VnfdBuilder(osm5.ns.yang.nfvo.mano.types.rev170208.HttpEndpoints arg) {
        this._httpEndpoint = arg.getHttpEndpoint();
    }
     ...
     * <ul>
     * <li>org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.HttpEndpoints</li>
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof osm5.ns.yang.nfvo.mano.types.rev170208.HttpEndpoints) {
            this._httpEndpoint = ((osm5.ns.yang.nfvo.mano.types.rev170208.HttpEndpoints)arg).getHttpEndpoint();
            isValidArg = true;
        }
        ...
        if (arg instanceof osm5.ns.riftware._1._0.vnfd.base.rev170228.VnfdDescriptor) {
            this._id = ((osm5.ns.riftware._1._0.vnfd.base.rev170228.VnfdDescriptor)arg).getId();
            this._name = ((osm5.ns.riftware._1._0.vnfd.base.rev170228.VnfdDescriptor)arg).getName();
            this._shortName = ((osm5.ns.riftware._1._0.vnfd.base.rev170228.VnfdDescriptor)arg).getShortName();
            this._vendor = ((osm5.ns.riftware._1._0.vnfd.base.rev170228.VnfdDescriptor)arg).getVendor();
            this._logo = ((osm5.ns.riftware._1._0.vnfd.base.rev170228.VnfdDescriptor)arg).getLogo();
            this._description = ((osm5.ns.riftware._1._0.vnfd.base.rev170228.VnfdDescriptor)arg).getDescription();
            this._version = ((osm5.ns.riftware._1._0.vnfd.base.rev170228.VnfdDescriptor)arg).getVersion();
            this._vnfConfiguration = ((osm5.ns.riftware._1._0.vnfd.base.rev170228.VnfdDescriptor)arg).getVnfConfiguration();
            this._operationalStatus = ((osm5.ns.riftware._1._0.vnfd.base.rev170228.VnfdDescriptor)arg).getOperationalStatus();
            this._mgmtInterface = ((osm5.ns.riftware._1._0.vnfd.base.rev170228.VnfdDescriptor)arg).getMgmtInterface();
            this._internalVld = ((osm5.ns.riftware._1._0.vnfd.base.rev170228.VnfdDescriptor)arg).getInternalVld();
            this._connectionPoint = ((osm5.ns.riftware._1._0.vnfd.base.rev170228.VnfdDescriptor)arg).getConnectionPoint();
            this._vdu = ((osm5.ns.riftware._1._0.vnfd.base.rev170228.VnfdDescriptor)arg).getVdu();
            this._vduDependency = ((osm5.ns.riftware._1._0.vnfd.base.rev170228.VnfdDescriptor)arg).getVduDependency();
            this._serviceFunctionChain = ((osm5.ns.riftware._1._0.vnfd.base.rev170228.VnfdDescriptor)arg).getServiceFunctionChain();
            this._serviceFunctionType = ((osm5.ns.riftware._1._0.vnfd.base.rev170228.VnfdDescriptor)arg).getServiceFunctionType();
            this._scalingGroupDescriptor = ((osm5.ns.riftware._1._0.vnfd.base.rev170228.VnfdDescriptor)arg).getScalingGroupDescriptor();
            this._monitoringParam = ((osm5.ns.riftware._1._0.vnfd.base.rev170228.VnfdDescriptor)arg).getMonitoringParam();
            this._placementGroups = ((osm5.ns.riftware._1._0.vnfd.base.rev170228.VnfdDescriptor)arg).getPlacementGroups();
            isValidArg = true;
        }
        CodeHelpers.validValue(isValidArg, arg, "[org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.HttpEndpoints, org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.IpProfileList, org.opendaylight.yang.gen.v1.http.riftio.com.ns.riftware._1._0.vnfd.base.rev170228.VnfdDescriptor]");
    }
    ...
    public static final class VnfdImpl implements Vnfd {
        ...
        @Override
        public osm5.ns.riftware._1._0.vnfd.base.rev170228.VnfdDescriptor.ServiceFunctionChain getServiceFunctionChain() {
            return _serviceFunctionChain;
        }
