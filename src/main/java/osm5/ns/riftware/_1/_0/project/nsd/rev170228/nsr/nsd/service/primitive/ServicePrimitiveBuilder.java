package osm5.ns.riftware._1._0.project.nsd.rev170228.nsr.nsd.service.primitive;
import com.google.common.base.MoreObjects;
import com.google.common.collect.ImmutableMap;

import osm5.ns.riftware._1._0.project.nsd.rev170228.nsr.nsd.service.primitive.service.primitive.Parameter;
import osm5.ns.riftware._1._0.project.nsd.rev170228.nsr.nsd.service.primitive.service.primitive.VnfPrimitiveGroup;
...
public class ServicePrimitiveBuilder implements Builder<ServicePrimitive> {
    ...
    public ServicePrimitiveBuilder(osm5.ns.yang.nfvo.mano.types.rev170208.UiPrimitiveGroup arg) {
     ...
     * <ul>
     * <li>org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.UiPrimitiveGroup</li>
     * </ul>
     *
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof osm5.ns.yang.nfvo.mano.types.rev170208.UiPrimitiveGroup) {
            this._parameterGroup = ((osm5.ns.yang.nfvo.mano.types.rev170208.UiPrimitiveGroup)arg).getParameterGroup();
            isValidArg = true;
        }
        CodeHelpers.validValue(isValidArg, arg, "[org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.UiPrimitiveGroup]");
    }
