...
public final class $YangModuleInfoImpl extends ResourceYangModuleInfo {
    private static final QName NAME = QName.create("http://riftio.com/ns/riftware-1.0/project-vnfd", "2017-02-28", "project-vnfd").intern();
    ...
    private $YangModuleInfoImpl() {
        ...
        set.add(osm5.ns.riftware._1._0.vnfd.base.rev170228.$YangModuleInfoImpl.getInstance());
