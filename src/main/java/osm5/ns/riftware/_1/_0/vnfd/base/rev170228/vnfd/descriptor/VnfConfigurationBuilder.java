...
public class VnfConfigurationBuilder implements Builder<VnfConfiguration> {
    ...
    public VnfConfigurationBuilder(osm5.ns.yang.nfvo.mano.types.rev170208.VcaConfiguration arg) {
    ...
    public VnfConfigurationBuilder(osm5.ns.yang.nfvo.mano.types.rev170208.VcaMetrics arg) {
        this._metrics = arg.getMetrics();
    }
