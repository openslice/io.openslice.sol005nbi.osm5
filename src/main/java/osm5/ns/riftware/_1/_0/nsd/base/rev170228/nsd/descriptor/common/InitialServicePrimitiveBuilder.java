...
import osm5.ns.yang.nfvo.mano.types.rev170208.event.config.Parameter;
...
public class InitialServicePrimitiveBuilder implements Builder<InitialServicePrimitive> {
    ...
    public InitialServicePrimitiveBuilder(osm5.ns.yang.nfvo.mano.types.rev170208.EventConfig arg) {
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof osm5.ns.yang.nfvo.mano.types.rev170208.EventConfig) {
            this._seq = ((osm5.ns.yang.nfvo.mano.types.rev170208.EventConfig)arg).getSeq();
            this._name = ((osm5.ns.yang.nfvo.mano.types.rev170208.EventConfig)arg).getName();
            this._userDefinedScript = ((osm5.ns.yang.nfvo.mano.types.rev170208.EventConfig)arg).getUserDefinedScript();
            this._parameter = ((osm5.ns.yang.nfvo.mano.types.rev170208.EventConfig)arg).getParameter();
            isValidArg = true;
        }
        CodeHelpers.validValue(isValidArg, arg, "[org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.nfvo.mano.types.rev170208.EventConfig]");
    }
